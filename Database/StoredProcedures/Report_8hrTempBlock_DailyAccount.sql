USE [iMonnit]
GO
/****** Object:  StoredProcedure [dbo].[Report_8hrTempBlock_DailyAccount]    Script Date: 6/4/2024 8:44:41 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[Report_8hrTempBlock_DailyAccount]
...
SELECT Name = AccountNumber from Account where AccountID = @Default_OwnerAccountID
