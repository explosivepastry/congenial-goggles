...
/****** Object:  StoredProcedure [dbo].[Report_LoadAutoExport]    Script Date: 6/28/2024 4:09:59 PM ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 CREATE PROCEDURE [dbo].[Report_LoadAutoExport]
  @AccountID BIGINT
AS
 ...
 --Parameters
  ...
  INNER JOIN dbo.[SensorAttribute] sa on t.SensorId = sa.SensorID;
	...
	INSERT INTO ExportStatistics (ExportDate,FirstMessageDate, LastMessageDate,MessageCount, AccountID)
		VALUES (GETDATE(),@FirstDataMessage,@LastDatMessage, @Count, @_AccountID);
