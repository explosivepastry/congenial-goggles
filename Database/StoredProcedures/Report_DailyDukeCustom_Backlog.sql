...
/****** Object:  StoredProcedure [dbo].[Report_DailyDukeCustom_Backlog]    Script Date: 6/24/2024 2:53:14 PM ******/
SET ANSI_NULLS ON
GO
...
--exec [dbo].[Report_DailyDukeCustom_Backlog]

CREATE PROCEDURE [dbo].[Report_DailyDukeCustom_Backlog]
	
AS
declare @dt DATE = '2024-03-24'
/*
  7 Table Result set
  ------------------------------------------------------
    Table 1: Accounts
...
SET @FromDate = dbo.GetUTCTime(CONVERT(DATE, DATEADD(DAY, -1, dbo.GetLocalTime(@dt, @TimeZoneIDString))), @TimeZoneIDString)
