  		...
  		<div id="wizard" class="swMain">
            ...
            <table cellspacing="3" cellpadding="3" align="center">
          			...
          			<tr>
                    	...
                    	<td align="left">
                    	  <input type="password" id="password" name="password" value="" class="txtBox" autocomplete="off" >
                      </td>
                ...
                <tr>
                    	...
                    	<td align="left">
                    	  <input type="password" id="cpassword" name="cpassword" value="" class="txtBox" autocomplete="off" >
                      </td>
