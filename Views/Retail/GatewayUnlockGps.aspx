...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        ...
        <%:Html.Partial("RedeemCreditHeader", Model as Account, new ViewDataDictionary { { "CreditClassification", eCreditClassification.GatewayUnlockGps.ToInt() } }) %>

        <%if (MonnitSession.CustomerCan("Account_Edit"))
            {
                CreditSetting cs = Monnit.CreditSetting.LoadByAccountID(Model.AccountID, eCreditClassification.GatewayUnlockGps);
                if (cs == null)
                {
                    ...
                    cs.CreditClassification = eCreditClassification.GatewayUnlockGps;
                }%>
        <div class="col-12">
            <div class="rule-card_container  w-100">
                <div class="card_container__top">
                    <div class="card_container__top__title">
                        <span>
                            <%: Html.TranslateTag("Retail/GatewayUnlock|GPS Unlock Credits", "GPS Unlock Credits")%>
                        </span>
                    </div>
                </div>
                <div class="x_content">
                    <%:Html.Partial("GatewayUnlockGpsCreditSettings", cs) %>

                    <%=Html.Partial("_GatewayList", cs, new ViewDataDictionary { { "GatewayList", ViewBag.GatewayList }, { "GatewayListType", "GatewayUnlockGps" } })%>
        ...
        <%} %>
        <div class=" ">
            <div class="rule-card_container gps-US w-100">
                <div class="card_container__top">
                    <div class="card_container__top__title">
                        <span>
                            <%: Html.TranslateTag("GPS Unlock Store", "GPS Unlock Store")%>
                        </span>
                    </div>
                </div>
                <div class="x_content col-12" style="max-width: 500px">
                    <div class="bold" style="font-weight: bold;">
                        <div style="padding-top: 2px;" class="form-group"><%: Html.TranslateTag("Retail/GatewayUnlockGps|GPS Unlock Credits", "GPS Unlock Credits")%>:</div>
                    </div>
                    <div class="" style="margin-bottom: 5px; padding-left: 10px;">
                        <%string spDesc = "Activate GPS functionality in an ALTA IoT Gateway with a unique unlock code in iMonnit. Just purchase the ALTA IoT Gateway GPS Unlock credit, and you’ll receive the code to turn on the GPS feature in a few simple steps. By unlocking GPS capability, you’ll have access to this valuable data at regular preset intervals. The IoT Gateway is the only ALTA Gateway with GPS.";%>
                        <%: Html.TranslateTag("Events/TriggersSensors|" + spDesc, spDesc)%>
                    </div>
                    <div class="form-group row">
                        <div class="form-group row col-12">
                            <div class="bold" style="font-weight: bold;">
                                <div style="padding-left: 20px; padding-top: 2px;" class="form-group">
                                    <%: Html.TranslateTag("Retail/GatewayUnlockGps|Purchase GPS Unlock Credits","Purchase GPS Unlock Credits")%>:
                                </div>
                            </div>
                            ...
                            <br />
                            <div style="padding-left: 20px; padding-top: 2px;" class="bold form-group"><%: Html.TranslateTag("Retail/GatewayUnlockGps|Quantity","Quantity")%>:</div>
        ...
        <%if (MonnitSession.IsCurrentCustomerMonnitSuperAdmin)
            {%>
        <div class="">
            <div class="rule-card_container gps-UAC w-100 " >
                <div class="card_container__top">
                    <div class="card_container__top__title">
                        <span>
                            <%: Html.TranslateTag("Retail/NotificationCredit| GPS Unlock Administrative Credit","GPS Unlock Administrative Credit")%>
                        </span>
                    </div>
                </div>
                <div class="ms-2">
        ...
        <script type="text/javascript">
            ...
            function assignCredits(a) {
                ...
                var url = $(a).attr("href") + $('#MessageCreditsToAssign').val() + '&creditClassification=<%=eCreditClassification.GatewayUnlockGps.ToInt()%>';
    ...
    <div class="spinner-border text-primary" style="margin-top: 50px;" role="status">
        ...
        $('#activate').parent().parent().addClass('row');
        $('#activate').parent().addClass('col-6').after('<div class=" h6 fw-bold">Enter the activation code and select the IoT Gateway that you want to have GPS tracking enabled</h4>');
