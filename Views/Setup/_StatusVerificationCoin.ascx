...
<div class="tab tab-gateway tab-first">
    ...
    <div class="flex">
        ...
        <div class="step-process">
            <p><%: Html.TranslateTag("Insert Battery")%></p>
        </div>
    </div>
    <div class="flex">
...
<div class="tab tab-power" style="display: none;">
    ...
    <div class="flex">
        <div class="step-box">
            ...
            <span><%: Html.TranslateTag("Insert Battery")%></span>
        </div>
    ...
    <div class="flex" style="justify-content:center;">
        <img src="/Content/dashboard/images/Setup/BatteryCoin.png" />
    </div>

    <div>
        <p></p>
        <p class="battCheckComplete"><%: Html.TranslateTag("Insert battery into your sensor.")%></p>
