...
<div class="tab tab-antenna tab-first">
    ...
    <div class="flex">
        ...
        <div class="step-process">
            <p><%: Html.TranslateTag("Plug in Ethernet Cable")%></p>
        </div>
    </div>
    <div class="flex">
...
<div class="tab tab-network" style="display: none;">
    ...
    <div class="flex">
        <div class="step-box">
            ...
            <span><%: Html.TranslateTag("Plug in Ethernet Cable")%></span>
        </div>
    </div>
    <div class="flex">
        <div class="circle-fill"><%=Html.GetThemedSVG("3-circle-fill") %></div>
    ...
    <div>
        <p></p>
        <p><%: Html.TranslateTag("Plug in Ethernet cable to gateway and to an active network port.")%></p>
        <p><%: Html.TranslateTag("Then press Next to continue.")%></p>
    </div>
