...
<div class="tab tab-first tab-app">
    ...
    <div class="flex" style="justify-content:center;">
        <div>
            ...
            <%:Html.Partial("_USBDownload") %>
        </div>
    </div>

    <div>
        <p></p>
        <p><%: Html.TranslateTag("Download the USB application and install on the host computer.")%> </p>
...
<div class="tab tab-network tab-last" style="display: none;">
    ...
    <div class="flex">
        <div class="step-box">
            ...
            <span><%: Html.TranslateTag("Plug in USB")%></span>
        </div>
    </div>
    <div class="flex">
        <div class="circle-fill"><%=Html.GetThemedSVG("3-circle-fill") %></div>
    ...
    <div>
        <p></p>
        <p><%: Html.TranslateTag("Insert the USB into your host computer.")%></p>
        <p><%: Html.TranslateTag("Then press Next to continue.")%></p>
    </div>
    <div class="row-back-next">
        <div>
