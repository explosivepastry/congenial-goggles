...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%-- //purgeclassic --%>
<form action="/Admin/EditReleaseNotep" method="post">
    <% Html.RenderPartial("~/Views/Shared/_AntiForgeryToken.ascx"); %>
    <div>
        <%: Html.Hidden("id",Model.ReleaseNoteID) %>
        <div class="formtitle">Edit Release Note</div>
        <div class="formbody" >
            <table class="releaseNote" width="100%">
                ...
                <tr>
                    <td width="20" ></td>
                    <td style="vertical-align: top;height: 276px;"><label for="Note">Release Note</label></td>
                    <td >
                        <textarea id="editor"><%:Model.Note %></textarea>
