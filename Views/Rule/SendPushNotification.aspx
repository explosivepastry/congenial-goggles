...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%  //List<NotificationRecipientData> userList = NotificationRecipientData.SearchPotentialRecipient(MonnitSession.CurrentCustomer.CustomerID, MonnitSession.NotificationInProgress.AccountID, "");
        List<NotificationRecipientData> userList = NotificationRecipientData.SearchPotentialPushMessageRecipientForAccount(MonnitSession.CurrentCustomer.CustomerID, MonnitSession.NotificationInProgress.AccountID, "");
            ...
            <div class="msg_card1">
                <div class="msg-top">
                    ...
                    <div onclick="$('#myModal').modal('toggle');" class="user-inputs-box" style="cursor: pointer; display: flex">
                        ...
                        <div>
                            <div class="user-stamp" id="emailrecipients"><%=Html.Partial("_SendToNamesList", assignedRecipients.Where(m=>m.NotificationType == eNotificationType.Push_Message).ToList()) %></div>
                ...
                <div class="msg-sub">
                    ...
                    <textarea class="text-box-msg user-dets send-text-area-size" id="PushText" maxlength="160" name="PushText" ><%=MonnitSession.NotificationInProgress.NotificationText%></textarea>
                </div>
        ...
        $(function () {
            ...
            $('#saveNotificationBtn').click(function () {
                ...
                if (recipients.length == 0) {
                    ...
                    $.post('/Rule/SavePushNotificationSettings/', values, function (data) {
                        if (data == "Success") {
