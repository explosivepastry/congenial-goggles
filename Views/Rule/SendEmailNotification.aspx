            ...
            <div class=" msg_card1">
                <div class="msg-top">
                    ...
                    <div onclick="$('#myModal').modal('toggle');" class="user-inputs-box" style="cursor: pointer; display: flex;">
                        ...
                        <div>
                            <div class="user-stamp" id="emailrecipients"><%=Html.Partial("_SendToNamesList", assignedRecipients.Where(m=>m.NotificationType == eNotificationType.Email || m.NotificationType == eNotificationType.Group).ToList()) %></div>
                ...
                <div class="msg-sub">
                    ...
                    <input type="text" id="subject" placeholder="Subject" name="subject" required="required" value="<%=MonnitSession.NotificationInProgress.Subject %>" class="msg-input user-dets">
                ...
                <textarea id="editor"><%=MonnitSession.NotificationInProgress.NotificationText%></textarea>
                ...
                <%--<input type="hidden" id="NotificationText" name="NotificationText" value="" />--%>
            </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#recipientFilter').keyup(function (e) {
                //var query = $(this).val();
                //$('#recipientList').html("<div class=\"spinnerAlign spinner-border text-primary my-3\" role=\"status\"></div>");
                //$.post("/Rule/RuleRecipientList/", { q: query }, function (data) {
            ...
            $('#saveNotificationBtn').click(function () {
                ...
                if (recipients.length == 0) {
                    ...
                    $.post('/Rule/SaveEmailNotificationSettings/', values, function (data) {
                        if (data == "Success") {
