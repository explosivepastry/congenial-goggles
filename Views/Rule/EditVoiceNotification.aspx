    ...
    <div class="msg_container">
        ...
        <div class="msg-title" style="width: auto;">
            <div class="card_container__top__title">
                <%: Html.TranslateTag("Voice Call", "Voice Call")%>
            </div>
            <div class="col-xs-2" id="newRefresh" style="padding-left: 0px;">
                <div style="float: right; margin-bottom: 5px;">
                    <div class="btn-group" style="height: 45px;">
                        <a onclick="removeNotifyTask('<%=eNotificationType.Phone.ToInt() %>');" style="cursor: pointer;" title="<%=Html.TranslateTag("Remove") %>"><%=Html.GetThemedSVG("delete") %></a>
                    </div>
                </div>
            </div>
        ...
        <div class="msg-box">
            ...
            <div class="msg_card1">
                ...
                <div class="msg-sub">
                    ...
                    <textarea class="text-box-msg send-text-area-size user-dets" placeholder="<%: Html.TranslateTag("Rule/SendNotification|Place Voice Call Text Here")%>" id="VoiceText" class="form-control" maxlength="2000" name="VoiceText"><%=Model.VoiceText%></textarea>

                </div>
                    <a href="#" class="msg-preview overridePreview sendvoice-rule" data-type="Voice" data-bs-toggle="modal" data-bs-target=".previewOverride"><strong><%= Html.TranslateTag(" Message Preview") %></strong></a>
                <div class="msg-save">
    ...
    <script>
        ...
        $(function () {
            ...
            $('#saveNotificationBtn').click(function () {
                ...
                values["type"] = "<%=eNotificationType.Phone%>";

                values["VoiceText"] = $("#VoiceText").val();
                ...
                if (recipients.length == 0) {
                    ...
                    $.post('/Rule/EditVoiceNotificationSettings/<%=NotiID%>', values, function (data) {
                        if (data == "Success") {
...
/*                                var errorObjID = errorData[0];*/
        ...
        function saveRecipients() {
            ...
            var values = new Object();
            values["type"] = "<%=eNotificationType.Phone.ToInt()%>";
            var recipients = $('.notifyUser.selected');
            var recipientString = '';
