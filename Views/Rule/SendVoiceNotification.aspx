        ...
        <div class="msg-box">
            ...
            <div class="msg_card1">
                <div class="msg-top">
                    ...
                    <div onclick="$('#myModal').modal('toggle');" class="user-inputs-box" style="cursor: pointer; display: flex;">
                        ...
                        <div>
                            ...
                            <div class="user-stamp" id="emailrecipients"><%=Html.Partial("_SendToNamesList", assignedRecipients.Where(m=>m.NotificationType == eNotificationType.Phone).ToList()) %></div>
                ...
                <div class="msg-sub">
                    ...
                    <textarea class="text-box-msg send-text-area-size user-dets" id="VoiceText" maxlength="2000" name="VoiceText"><%=MonnitSession.NotificationInProgress.VoiceText%></textarea>
                </div>
                <a href="#" class="msg-preview overridePreview  " data-type="Voice" data-bs-toggle="modal" data-bs-target=".previewOverride" style="width: 95%">
                    <strong><%= Html.TranslateTag(" Message Preview") %></strong></a>
        ...
        $(function () {
            ...
            $('#saveNotificationBtn').click(function () {
                ...
                if (recipients.length == 0) {
                    ...
                    $.post('/Rule/SaveVoiceNotificationSettings/', values, function (data) {
                        if (data == "Success") {
