        ...
        <div class="msg-box">
            ...
            <div class="msg_card1">
                ...
                <div class="msg-sub">
                    ...
                    <textarea class="text-box-msg user-dets  send-text-area-size" placeholder="<%: Html.TranslateTag("Rule/SendNotification|160 character max")%>" id="SMSText" maxlength="160" name="SMSText" ><%=Model.SMSText%></textarea>
                </div>
        ...
        $(function () {
            ...
            $('#saveNotificationBtn').click(function () {
                ...
                if (recipients.length == 0) {
                    ...
                    $.post('/Rule/EditTextNotificationSettings/<%=NotiID%>', values, function (data) {
                        if (data == "Success") {
