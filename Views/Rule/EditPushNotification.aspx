...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <% 
        List<NotificationRecipientData> userList = NotificationRecipientData.SearchPotentialPushMessageRecipient(MonnitSession.CurrentCustomer.CustomerID, Model.NotificationID, "");
    ...
    <div class="msg_container">
        ...
        <div class="msg-title" style="width: auto;">
            <div class="card_container__top__title">
                <%: Html.TranslateTag("Send Push", "Send Push")%>
            </div>
            <div class="col-xs-2" id="newRefresh" style="padding-left: 0px;">
                <div style="float: right; margin-bottom: 5px;">
                    <div class="btn-group" style="height: 45px;">
                        <a onclick="removeNotifyTask('<%=eNotificationType.Push_Message.ToInt() %>');" style="cursor: pointer;" title="<%=Html.TranslateTag("Remove") %>"><%=Html.GetThemedSVG("delete") %></a>
                    </div>
                </div>
            </div>
        ...
        <div class="msg-box">
            ...
            <div class="msg_card1">
                ...
                <div class="msg-sub">
                    ...
                    <textarea class="text-box-msg user-dets  send-text-area-size" placeholder="<%: Html.TranslateTag("Rule/SendNotification|160 character max")%>" id="PushText" maxlength="160" name="PushText">
                        <%=Model.PushMsgText.Replace("\\n", "\n")%>
                    </textarea>
                </div>

                <a href="#" class="msg-preview overridePreview" data-type="Text" data-bs-toggle="modal" data-bs-target=".previewOverride"><strong><%= Html.TranslateTag("Message Preview") %></strong></a>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#saveNotificationBtn').click(function () {
                ...
                values["type"] = "<%=eNotificationType.Push_Message%>";

                values["PushText"] = $("#PushText").val();;
                ...
                if (recipients.length == 0) {
                    ...
                    $.post('/Rule/EditPushNotificationSettings/<%=NotiID%>', values, function (data) {
                        if (data == "Success") {
...
/*                                var errorObjID = errorData[0];*/
        ...
        function saveRecipients() {
            ...
            var values = new Object();
            values["type"] = "<%=eNotificationType.Push_Message.ToInt()%>";
            var recipients = $('.notifyUser.selected');
            var recipientString = '';
