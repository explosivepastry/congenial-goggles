...
<div class="methodDiv">
    <b>Method: WebHookRemoveAuthentication</b><br />
    Turns off authentication for desired webhook.<br />
    ...
    <h4>Example</h4>
<%--    <a href="/xml/WebHookRemoveAuthentication/Z3Vlc3Q6cGFzc3dvcmQ=" target="_blank">https://<%:Request.Url.Host %>/xml/WebHookRemoveAuthentication/Z3Vlc3Q6cGFzc3dvcmQ=</a>--%>

<input type="button" id="btn_TryAPI_" class="btn btn-primary btn-sm" value="Try this API" />
	<script>
		$(function () {
            $('#btn_TryAPI_').click(function () {
				var json =
				{
					"auth": true,					
                    "api": "",
