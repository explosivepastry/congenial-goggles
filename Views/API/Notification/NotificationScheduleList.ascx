...
<div class="methodDiv">
    ...
    Returns a list of Schedules for a specific notification<br />
...
<input type="button" id="btn_TryAPI_NotificationScheduleList" class="btn btn-primary btn-sm" value="Try this API" />
	<script>
		$(function () {
            $('#btn_TryAPI_NotificationScheduleList').click(function () {
				var json =
				{
					"auth": true,					
                    "api": "NotificationScheduleList",
					"params": [
                        { "name": "notificationID", "type": "Long", "description": "Brings back a list of all the daily schedules for the specific notification", "optional": false },
                        { "name": "day", "type": "string", "description": "Brings back a single day's schedule", "optional": true }					
					]
				};								
				APITest(json);
			});
