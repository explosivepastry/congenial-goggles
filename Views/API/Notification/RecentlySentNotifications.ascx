...
<div class="methodDiv">
    ...
    Returns notifications recorded in a range of time (limited to a 12 hour window)<br />
...
<input type="button" id="btn_TryAPI_RecentlySentNotifications" class="btn btn-primary btn-sm" value="Try this API" />
	<script>
		$(function () {
            $('#btn_TryAPI_RecentlySentNotifications').click(function () {
				var json =
				{
					"auth": true,					
                    "api": "RecentlySentNotifications",
                    "params": [
                        { "name": "minutes", "type": "Integer", "description": "Number of minutes past Notifications will be returned", "optional": false },
                        { "name": "LastSentNotificationID", "type": "Long", "description": "Limits notification results to notifications sent after this ID", "optional": true },
