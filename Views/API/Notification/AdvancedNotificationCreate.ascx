...
<div class="methodDiv">
    <b>Method: AdvancedNotificationCreate</b><br />
    Create or edit an advanced notification.<br />
    ...
    <table>
     ...
     <b>*Special Case: To set Advanced Parameters See API call "NotificationListAdvancedParameters" *</b><br />

    <h4>Example</h4>
<%--    <a href="/xml/AdvancedNotificationCreate/Z3Vlc3Q6cGFzc3dvcmQ=?AdvancedNotificationID=1&name=Advanced+Notification&text=This+Is+a+test+notification&smsText=&voiceText=&subject=test+Notification&snooze=120&autoAcknowledge=true&jointSnooze=true" target="_blank">https://<%:Request.Url.Host %>/xml/AdvancedNotificationCreate/Z3Vlc3Q6cGFzc3dvcmQ=?advancedNotificationID=1&amp;name=Advanced+Notification&amp;text=This+Is+a+test+notification&amp;smsText=&amp;voiceText=
        &amp;subject=test+Notification&amp;snooze=120&amp;autoAcknowledge=true&amp;jointSnooze=true</a>--%>

<input type="button" id="btn_TryAPI_AdvancedNotificationCreate" class="btn btn-primary btn-sm" value="Try this API" />
	<script>
		$(function () {
            $('#btn_TryAPI_AdvancedNotificationCreate').click(function () {
				var json =
				{
					"auth": true,					
                    "api": "AdvancedNotificationCreate",
					"params": [
...
&nbsp;&nbsp;&nbsp;&nbsp;&lt;APINotification&gt;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;APINotification NotificationID="519" Name="Advanced notification test" Subject="test notification" Text="" SMSText="" VoiceText="" PushMsgText="" AccountID="1" Active="False" JointSnooze="True" AutoAcknowledge="True" Comparer="Equal" Theshold="0" Scale="" Snooze="120" LastDateSent="8/31/2016 7:35:03 PM" DatumType="" AdvancedNotificationID="1" NotificationClass="Advanced" Status="Armed" AcknowledgedBy" AcknowledgedByID="" AcknowledgedTime="1/1/0001 12:00:00 AM" AcknowledgeMethod="" ResetTime="1/1/0001 12:00:00 AM" /&gt;
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/APINotification&gt;
&nbsp;&nbsp;&lt;/Result&gt;
&lt;/SensorRestAPI&gt;</pre>
</div>
