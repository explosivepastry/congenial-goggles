...
<input type="button" id="btn_TryAPI_SentNotifications" class="btn btn-primary btn-sm" value="Try this API" />
	<script>
		$(function () {
            $('#btn_TryAPI_SentNotifications').click(function () {
				var json =
				{
					"auth": true,					
                    "api": "SentNotifications",
					"params": [
                        { "name": "from", "type": "DateTime", "description": "from is the starting point of the time period for your date range of notifications sent", "optional": false },
                        { "name": "to", "type": "DateTime", "description": "to is the ending point of the time period for your date range for notifications sent", "optional": false },					
                        { "name": "SensorID", "type": "Long", "description": "Limits which sensor notifications will come back. If this field is left null it will bring back all notifications for all sensors.", "optional": true }						
					]
				};								
				APITest(json);
			});
