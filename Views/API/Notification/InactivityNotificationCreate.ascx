...
<div class="methodDiv">
    <b>Method: InactivityNotificationCreate</b><br />
    ...
    <table>
        ...
        <tr>
         ...
         <tr>
            <td>threshold:</td>
            <td>String</td>
            <td>Duration of time without communication in minutes ( 0 - 525600 )</td>
        </tr>
         <tr>
            <td>Snooze:</td>
            <td>Integer</td>
    ...
    <h4>Example</h4>
<%--    <a href="/xml/InactivityNotificationCreate/Z3Vlc3Q6cGFzc3dvcmQ=?name=Inactivity+Notification&text=This+Is+a+test+notification&smsText=&voiceText=&subject=test+Notification&Threshold=245&snooze=120&autoAcknowledge=true&jointSnooze=true" target="_blank">https://<%:Request.Url.Host %>/xml/InactivityNotificationCreate/Z3Vlc3Q6cGFzc3dvcmQ=?name=Low_Battery+Notification&amp;text=This+Is+a+test+notification&amp;smsText=&amp;voiceText=&amp;subject=test+Notification&amp;threshold=245&amp;snooze=120&amp;autoAcknowledge=true&amp;jointSnooze=true</a>--%>

<input type="button" id="btn_TryAPI_InactivityNotificationCreate" class="btn btn-primary btn-sm" value="Try this API" />
	<script>
		$(function () {
            $('#btn_TryAPI_InactivityNotificationCreate').click(function () {
				var json =
				{
					"auth": true,					
                    "api": "InactivityNotificationCreate",
					"params": [
...
&nbsp;&nbsp;&nbsp;&nbsp;&lt;APINotification&gt;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;APINotification NotificationID="519" Name="Inactivity test" Subject="test notification" Text="" SMSText="" VoiceText="" PushMsgText="" AccountID="1" Active="False" JointSnooze="True" AutoAcknowledge="True" Comparer="Equal" Theshold="245" Scale="" Snooze="120" LastDateSent="1/1/0001 12:00:00 AM" DatumType=""  AdvancedNotificationID="-9223372036854775808" NotificationClass="Inactivity" Status="Armed" AcknowledgedBy="" AcknowledgedByID="" AcknowledgedTime="1/1/0001 12:00:00 AM" AcknowledgeMethod="" ResetTime="1/1/0001 12:00:00 AM" /&gt;
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/APINotification&gt;
&nbsp;&nbsp;&lt;/Result&gt;
&lt;/SensorRestAPI&gt;</pre>
</div>
