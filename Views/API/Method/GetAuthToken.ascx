...
<div class="methodDiv">
    ...
    Returns authorization token for username password to be used in all other api methods.  This token remains valid until your password is updated in iMonnit.<br /><br />
    ...
    <table>
        <tr>
            <td>Username:</td>
            <td>String</td>
            <td>Username you use to access iMonnit</td>
        </tr>
        <tr>
            <td>Password:</td>
            <td>String</td>
            <td>Password you use to access iMonnit</td>
        </tr>
    </table>
...
&lt;/SensorRestAPI&gt;</pre>
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td>Password</td>
                <td><input type="password" id="GetAuthTokenPassword" style="width: 153px; border-color: #aaa;" /></td>
            </tr>
            <tr>
                <td></td>
