...
<div class="methodDiv">
    <b>Method: SensorApplicationIDGet</b><br />
    ...
    <h4>Example</h4>
    <%--<a href="/xml/SensorApplicationIDGet/Z3Vlc3Q6cGFzc3dvcmQ=?sensorID=101" target="_blank">https://<%:Request.Url.Host %>/xml/SensorApplicationIDGet/Z3Vlc3Q6cGFzc3dvcmQ=?sensorID=101</a>--%>
    <input type="button" id="btn_TryAPI_SensorApplicationIDGet" class="btn btn-primary btn-sm" value="Try this API" />

	<script>
		$(function () {
			$('#btn_TryAPI_SensorApplicationIDGet').click(function () {
				var json =
				{
					"auth": true,					
					"api": "SensorApplicationIDGet",
					"params": [
