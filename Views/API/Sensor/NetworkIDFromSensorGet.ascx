...
<div class="methodDiv">
    ...
    <%--<a href="/xml/NetworkIDFromSensorGet/Z3Vlc3Q6cGFzc3dvcmQ=?sensorID=101" target="_blank">https://<%:Request.Url.Host %>/xml/NetworkIDFromSensorGet/Z3Vlc3Q6cGFzc3dvcmQ=?sensorID=101</a>--%>
     <input type="button" id="btn_TryAPI_NetworkIDFromSensorGet" class="btn btn-primary btn-sm" value="Try this API" />

	<script>
		$(function () {
			$('#btn_TryAPI_NetworkIDFromSensorGet').click(function () {
				var json =
				{
					"auth": true,					
					"api": "NetworkIDFromSensorGet",
					"params": [
