...
<div class="methodDiv">
	<b>Method: SensorSetIP</b><br />
	<br />
	Set the IP address, Subnet Mask, Default Gateway, and DNS Server of a Sensor.<br />
	...
	<table>
		...
		<tr>
			<td>IPAddress:</td>
			<td>String</td>
			<td>This is the IP address assigned to the sensor. Setting the IP address to 0.0.0.0 will force the sensor to use DHCP.</td>
		</tr>
		<tr>
			<td>NetworkMask:</td>
			<td>String</td>
	...
	<h4>Example</h4>
	<%--<a href="/xml/SensorSetIP/Z3Vlc3Q6cGFzc3dvcmQ=?SensorID=12345&ipAddress=192.168.100.10&networkMask=255.255.255.0&defaultGateway=192.168.100.1&dnsServer=75.75.75.0" target="_blank">https://<%:Request.Url.Host %>/xml/SensorSetIP/Z3Vlc3Q6cGFzc3dvcmQ=?SensorID=12345&amp;ipAddress=192.168.100.10&amp;networkMask=255.255.255.0&amp;defaultGateway=192.168.100.1&amp;dnsServer=75.75.75.0"</a>--%>
	<input type="button" id="btn_TryAPI_SensorSetIP" class="btn btn-primary btn-sm" value="Try this API" />

	<script>
		$(function () {
			$('#btn_TryAPI_SensorSetIP').click(function () {
				var json =
				{
					"auth": true,					
					"api": "SensorSetIP",
