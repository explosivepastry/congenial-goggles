...
<div class="methodDiv">
   ...
   <%-- <a href="/xml/RemoveSubAccount/Z3Vlc3Q6cGFzc3dvcmQ=?accountID=1234" target="_blank">https://<%:Request.Url.Host %>/xml/RemoveSubAccount/Z3Vlc3Q6cGFzc3dvcmQ=?accountID=1234</a>--%>
    <input type="button" id="btn_TryAPI_RemoveSubAccount" class="btn btn-primary btn-sm" value="Try this API" />

	<script>
		$(function () {
			$('#btn_TryAPI_RemoveSubAccount').click(function () {
				var json =
				{
					"auth": true,					
					"api": "RemoveSubAccount",
					"params": [
						{ "name": "accountID", "type": "Integer", "description": "Unique identifier of the account", "optional": false }						
					]
				};								
				APITest(json);
			});
