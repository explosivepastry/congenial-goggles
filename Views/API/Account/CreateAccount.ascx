...
<div class="methodDiv">
    ...
    <h4>Parameters</h4>
    <table class="CreateAccount_Params">
        <tr>
            <td>CompanyName:</td>
            <td>string</td>
    ...
    <h4>Example</h4>
    <%--<a href="/xml/CreateAccount?companyName=APICompany+Test&timeZoneID=1&address=7304+South+Cottonwood&address2=Suite+204&city=SLC&state=Utah&postalCode=74047&country=USA&userName=API.Tester&password=password&confirmPassword=password&firstName=API&lastName=Tester&notificationEmail=api.tester@invalid.com" target="_blank">https://<%:Request.Url.Host %>/xml/CreateAccount?companyName=APICompany+Test&amp;timeZoneID=1&amp;address=7304+South+Cottonwood&amp;address2=Suite+204&amp;city=SLC&amp; state=Utah&amp;postalCode=74047&amp;country=USA&amp;userName=API.Tester&amp;password=password&amp;confirmPassword=password&amp;firstName=API&amp; lastName=Tester&amp;notificationEmail=api.tester@invalid.com</a>--%>
    <input type="button" id="btn_TryAPI_CreateAccount" class="btn btn-primary btn-sm" value="Try this API" />

	<script>
		$(function () {
			$('#btn_TryAPI_CreateAccount').click(function () {
				var json =
				{
					"auth": false,					
					"api": "CreateAccount",
					"params": [
						...
						{ "name": "PostalCode", "type": "String", "description": "Postal Code for account", "optional": false },
						{ "name": "Country", "type": "String", "description": "Country for account", "optional": false },
						{ "name": "ResellerID", "type": "Integer", "description": "Identifier of reseller where hardware was purchased", "optional": true },
