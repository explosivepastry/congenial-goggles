...
<div class="methodDiv">
    <b>Method: AccountUserScheduleGet</b><br />
    Get Notification schedule for a User<br />
    ...
    <h4>Example</h4>
    <%--<a href="/xml/AccountUserScheduleGet/Z3Vlc3Q6cGFzc3dvcmQ=?userID=1" target="_blank">https://<%:Request.Url.Host %>/xml/AccountUserScheduleGet/Z3Vlc3Q6cGFzc3dvcmQ=?userID=1</a>--%>
     <input type="button" id="btn_TryAPI_AccountUserScheduleGet" class="btn btn-primary btn-sm" value="Try this API" />

	<script>
		$(function () {
			$('#btn_TryAPI_AccountUserScheduleGet').click(function () {
				var json =
				{
					"auth": true,					
					"api": "AccountUserScheduleGet",
                    "params": [					
