<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/DefaultAdmin.Master" Inherits="System.Web.Mvc.ViewPage<Monnit.AccountIncrement>" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#actSearch_Button').click(function () {
                ...
                $('.Result_Div').hide();
                searchRequest = $.get("/Settings/AutoBillAccountList?searchCriteria=" + encodeURIComponent($('#actSearch_Box').val()), function (data) {
                    $('#actSearch_Button').toggle();
                    $('#actSearch_Spinner').toggle();
            ...
            $('#allAccts_Button').click(function () {
                ...
                $('#allAccts_Spinner').toggle();
                $('.Result_Div').hide();
                searchRequest = $.get("/Settings/AutoBillAccountList?searchCriteria=Show All", function (data) {
                    $('#allAccts_Button').toggle();
                    $('#allAccts_Spinner').toggle();
                    $("#actSearch_List").html(data);
                    $('#actSearch_Result').show();
