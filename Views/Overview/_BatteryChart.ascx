...
<% 
    ...
    {
        dataVals.Append("[new Date(" + Monnit.TimeZone.GetLocalTimeById(item.MessageDate, MonnitSession.CurrentCustomer.Account.TimeZoneID).ToEpochTime() + ")," + item.Battery + "],");
    }
%>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var echartBar = echarts.init(document.getElementById('sensorChartDiv_<%= SensorID %>', 'infographic'));
