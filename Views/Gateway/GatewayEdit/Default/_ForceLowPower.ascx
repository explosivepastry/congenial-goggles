...
<% if (new Version(Model.GatewayFirmwareVersion) >= new Version("1.2.0.0"))
	{ %>

<div class="row sensorEditForm">
	<div class="col-12 col-md-3">
		<%: Html.TranslateTag("Gateway/_ForceLowPower|Gateway Power Mode","Gateway Power Mode")%>
	</div>
	<div class="col sensorEditFormInput">
		<select class="form-select ms-0" name="GatewayPowerMode" id="GatewayPowerMode">
