...
<form action="/Sensor/AdvancedEdit/<%:Model.SensorID %>" id="simpleEdit_<%:Model.SensorID %>" method="post">
    ...
    <div class="formtitle">
        <%: Model.MonnitApplication.ApplicationName%> Sensor Configuration
    </div>
    <div class="formBody">
        ...
        <table style="width: 100%;">
            <% 
                ...
                if (Model.MonnitApplication.IsTriggerProfile == eApplicationProfileType.Interval)
                {
                    ...
                    Html.RenderPartial("~/Views/Sensor/SensorEdit/_MinThreshold.ascx", Model);
                    Html.RenderPartial("~/Views/Sensor/SensorEdit/_MaxThreshold.ascx", Model);
                    Html.RenderPartial("~/Views/Sensor/SensorEdit/_Hysteresis.ascx", Model);
