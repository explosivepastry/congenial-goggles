...
<%    //MagnetDetect = 32
    ...
    string ZeroValue = "No Magnet\\nDetected";
    string OneValue = "Magnet\\nDetected";
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        echartBar32 = echarts.init(document.getElementById('sensorChartDiv_<%=Model.GroupSensor.SensorID%>_<%=Model.GroupSensor.DatumIndex%>', 'infographic'));

        echartBar32.setOption({  
        ...
        $(window).on('resize', function () {
            if (echartBar32 != null && echartBar32 != undefined) {
                echartBar32.resize();
            }
        });
