...
<div class="formBody">
    ...
    <table style="width: 100%;">
        ...
        <%--Threshold--%>
        <% Html.RenderPartial("~/Views/Sensor/ApplicationSpecific/67/_Threshhold.ascx", Model); %>

        <%--Hysteresis--%>
        <% Html.RenderPartial("~/Views/Sensor/ApplicationSpecific/67/_Hysteresis.ascx", Model); %>
