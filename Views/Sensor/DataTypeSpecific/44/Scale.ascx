    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td style="width: 588px;">
                <input class="aSettings__input_input" type="text"  id="lowValue" name="lowValue" value="<%:Monnit.Analog.GetLowValue(Model.SensorID) %>" />
            </td>
        </tr>
        <tr>
            <td>1.2 Volt Value:
            ...
            <td style="width: 588px;">
                <input class="aSettings__input_input" style=" text-align: left;" type="text"  id="highValue" name="highValue" value="<%:Monnit.Analog.GetHighValue(Model.SensorID) %>" />
            </td>
        </tr>
        <tr>
            <td>Label:
            ...
            <td style="width: 588px;">
                <input class="aSettings__input_input" style=" text-align: left;" type="text" id="label" name="label" value="<%:Monnit.Analog.GetLabel(Model.SensorID) %>" />
            </td>
        </tr>
            <script>
