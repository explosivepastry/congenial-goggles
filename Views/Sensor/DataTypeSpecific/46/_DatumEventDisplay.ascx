...
<div class="reading-tag1">
    ...
    <div class="triggerDevice__name">
        ...
        <span class="reading-tag-condition"><%=Html.TranslateTag(MonnitSession.NotificationInProgress.CompareType.ToString().Replace("_"," ")) %> <%=Model.CompareValue %> <%= Html.TranslateTag("Micrograms") %>
        </span>
    </div>
