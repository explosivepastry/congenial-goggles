...
<form action="/Sensor/AdvancedEdit/<%:Model.SensorID %>" id="simpleEdit_<%:Model.SensorID %>" method="post">
    ...
    <div class="formBody">
        ...
        <table style="width: 100%;">
            ...
            <%-- Display--%>
            <% Html.RenderPartial("~/Views/Sensor/ApplicationSpecific/34/_Display.ascx", Model); %>
            ...
            <%--Threshold--%>
            <%--Hysteresis--%>
            <% Html.RenderPartial("~/Views/Sensor/ApplicationSpecific/34/_HystMinMax.ascx", Model); %>
