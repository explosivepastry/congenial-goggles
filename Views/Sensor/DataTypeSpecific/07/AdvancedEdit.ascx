...
<div class="formBody">
    ...
    <table style="width: 100%;">
        ...
        <%--Scale
        <% Html.RenderPartial("~/Views/Sensor/ApplicationSpecific/75/_Scale.ascx", Model);%>--%>
        <%--Heartbeat--%>
        ...
        <%-- roll pitch min max hysterisis --%>
        <% Html.RenderPartial("~/Views/Sensor/ApplicationSpecific/75/_RollPitch.ascx", Model); %>
        <%--Syncronize Offset--%>
