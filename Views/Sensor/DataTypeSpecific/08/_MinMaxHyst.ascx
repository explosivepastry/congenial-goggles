...
<tr>
    ...
    <td>
        <%: Html.TextBox("MaximumThreshold_Manual", Max, (Dictionary<string,object>)ViewData["HtmlAttributes"])%><%: ZeroToTwentyMilliamp.GetLabel(Model.SensorID) %>
...
<tr>
    ...
    <td>
        <%: Html.TextBox("Hysteresis_Manual", Hyst, (Dictionary<string,object>)ViewData["HtmlAttributes"])%><%: ZeroToTwentyMilliamp.GetLabel(Model.SensorID) %>
