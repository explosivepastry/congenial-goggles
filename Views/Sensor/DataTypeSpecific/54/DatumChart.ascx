...
<div class="row chart_row">
    <div class="col-12 col-lg-3 col-xl-3  chart_row__details" style="text-align: center;">
        ...
        <a target="_blank" href="/Overview/SensorChart/<%=Model.GroupSensor.SensorID %>" role="link" class="btn btn-primary btn-sm" style="width: 150px;">
            ...
            &nbsp;<%: Html.TranslateTag("Details","Details")%></a> <a href="/Overview/SensorHome/<%=Model.GroupSensor.SensorID %>" role="link" target="_blank" class="btn btn-secondary btn-sm mt-2" style="width: 150px;"><%=Html.GetThemedSVG("list") %>&nbsp;<%: Html.TranslateTag("History","History")%></a>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		var label = '<%: Model.Label == "GramsPerKilogram" ? "g/kg" : "gpp" %>';
