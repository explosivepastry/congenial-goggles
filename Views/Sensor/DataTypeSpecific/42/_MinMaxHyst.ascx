...
<tr>
    ...
    <td>
        <%: Html.TextBox("MinimumThreshold_Manual", Min, (Dictionary<string,object>)ViewData["HtmlAttributes"])%><%: ZeroToTenVolts.GetLabel(Model.SensorID)  %>
...
<tr>
    ...
    <td>
        <%: Html.TextBox("MaximumThreshold_Manual", Max, (Dictionary<string,object>)ViewData["HtmlAttributes"])%><%: ZeroToTenVolts.GetLabel(Model.SensorID) %>
...
<tr>
    ...
    <td>
        <%: Html.TextBox("Hysteresis_Manual", Hyst, (Dictionary<string,object>)ViewData["HtmlAttributes"])%><%: ZeroToTenVolts.GetLabel(Model.SensorID) %>
