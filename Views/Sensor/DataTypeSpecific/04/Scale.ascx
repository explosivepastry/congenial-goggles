    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td style="width: 588px;">
                <input class="aSettings__input_input" type="text"  id="lowValue" name="lowValue" value="<%:Monnit.ZeroToFiveVolts.GetLowValue(Model.SensorID) %>" />
            </td>
        </tr>
        <tr>
            <td>5 Volt Value:
            ...
            <td style="width: 588px;">
                <input class="aSettings__input_input" type="text"  id="highValue" name="highValue" value="<%:Monnit.ZeroToFiveVolts.GetHighValue(Model.SensorID) %>" />
            </td>
        </tr>
        <tr>
            <td>Label:
            ...
            <td style="width: 588px;">
                <input class="aSettings__input_input" type="text" id="label" name="label" value="<%:Monnit.ZeroToFiveVolts.GetLabel(Model.SensorID) %>" />
            </td>
        </tr>
            <script>
