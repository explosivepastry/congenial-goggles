...
<div class="row chart_row">
    ...
    <div class="col-12 col-lg-9 col-xl-9">
      <%--<div  id="sensorChartDiv_<%=Model.GroupSensor.SensorID%>_<%=Model.GroupSensor.DatumIndex%>_<%=sensorCount > 5 ? %> "style="height: 100px":"200px; width: 100%"> </div>--%>
         <div  id="sensorChartDiv_<%=Model.GroupSensor.SensorID%>_<%=Model.GroupSensor.DatumIndex%>" style="height: 100px":"200px; width: 100%"<%=sensorCount > 5 %> > </div>
