...
<% 
    ...
    List<UnitConversion> listOfConversions = Monnit.MonnitApplicationBase.GetScales(Model.SensorID, eDatumType.AirSpeedData);
...
<div class="rule-card">
    <div class="rule-title">
        Notify when sensor Air Speed reading is 
    </div>
    <div>
