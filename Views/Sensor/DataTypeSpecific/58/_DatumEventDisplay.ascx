...
<% 
    ...
    if (!String.IsNullOrEmpty(Model.Scale))
    {
        ...
        List<UnitConversion> listOfConversions = Monnit.MonnitApplicationBase.GetScales(sensor, eDatumType.AirSpeedData);
...
<div class="reading-tag1">
    ...
    <div class="triggerDevice__name">
        <strong style="margin-top: 10px;"><%: Html.TranslateTag("When the Air Speed is")%>:
            <br />
        </strong>
