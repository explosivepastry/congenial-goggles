...
<% 
    ...
    {
        case "cm":
            valcompare = Monnit.Application_Classes.DataTypeClasses.Millimeter.CentimeterToMillimeter(Model.CompareValue.ToDouble()).ToString();
            break;
        case "Meters":
            valcompare = Monnit.Application_Classes.DataTypeClasses.Millimeter.MeterToMillimeter(Model.CompareValue.ToDouble()).ToString();
            break;
        case "Inches":
            valcompare = Monnit.Application_Classes.DataTypeClasses.Millimeter.InchToMillimeter(Model.CompareValue.ToDouble()).ToString();
            break;
        case "Feet":
            valcompare = Monnit.Application_Classes.DataTypeClasses.Millimeter.FeetToMillimeter(Model.CompareValue.ToDouble()).ToString();
            break;
        case "Yards":
            valcompare = Monnit.Application_Classes.DataTypeClasses.Millimeter.YardToMillimeter(Model.CompareValue.ToDouble()).ToString();
            break;
        case "mm":
        default:
