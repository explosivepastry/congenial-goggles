...
<tr>
    ...
    <td>
        <%: Html.TextBox("MinimumThreshold_Manual", Min, (Dictionary<string,object>)ViewData["HtmlAttributes"])%><%: AC_DC_500V.GetLabel(Model.SensorID)  %>
        <%: Html.ValidationMessageFor(model => model.MinimumThreshold)%>
    </td>
    <td>
        <img alt="help" class="helpIcon" title="Any assessments below this value will cause the sensor to enter the Aware State." src="/Content/images/help.png" /></td>
</tr>
...
<tr>
    ...
    <td>
        <%: Html.TextBox("MaximumThreshold_Manual", Max, (Dictionary<string,object>)ViewData["HtmlAttributes"])%><%: AC_DC_500V.GetLabel(Model.SensorID) %>
        <%: Html.ValidationMessageFor(model => model.MaximumThreshold)%>
    </td>
    <td>
        <img alt="help" class="helpIcon" title="Any assessments above this value will cause the sensor to enter the Aware State." src="/Content/images/help.png" /></td>
</tr>
...
<tr>
    ...
    <td>
        <%: Html.TextBox("Hysteresis_Manual", Hyst, (Dictionary<string,object>)ViewData["HtmlAttributes"])%><%: AC_DC_500V.GetLabel(Model.SensorID) %>
