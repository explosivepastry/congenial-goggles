...
<div class="row chart_row">
    <div class="col-12 col-lg-3 col-xl-3 chart_row__details" style="text-align: center;">
        ...
        <a target="_blank" href="/Overview/SensorChart/<%=Model.GroupSensor.SensorID %>" role="link" class="btn btn-primary btn-sm"><%=Html.GetThemedSVG("chart") %>&nbsp;<%: Html.TranslateTag("Details","Details")%></a> 
        <a href="/Overview/SensorHome/<%=Model.GroupSensor.SensorID %>" role="link" target="_blank" class="btn btn-secondary btn-sm"><%=Html.GetThemedSVG("list") %>&nbsp;<%: Html.TranslateTag("History","History")%></a>
    </div>
