...
<div>
    ...
    <select class="form-select user-dets grt-less" style="width:250px;" id="CompareValue" name="CompareValue">
        <option value='True'>Activity Detected</option>
        <option value='False' <%:Model != null && (Model.CompareValue == "False") ? "selected='selected'": "" %>>Activity Not Detected</option>
    </select>
</div>
