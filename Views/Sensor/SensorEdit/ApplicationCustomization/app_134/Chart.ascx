...
<%
    bool isF = SootBlower.IsFahrenheit(Model.Sensors[0].SensorID);
    ...
    //StringBuilder PressureVals = new StringBuilder();
    //StringBuilder A_CurrentVals = new StringBuilder();
    //StringBuilder B_CurrentVals = new StringBuilder();
    //StringBuilder C_CurrentVals = new StringBuilder();
    //StringBuilder ModeVals = new StringBuilder();


    StringBuilder dataVals = new StringBuilder();
    string label = isF ? "F" : "C";
