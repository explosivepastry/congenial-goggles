...
<% Account acc = Account.Load(Model.AccountID);
    if (acc.CurrentSubscription.AccountSubscriptionType.Can("sensor_advanced_edit") && MonnitSession.CustomerCan("Sensor_Advanced_Configuration"))
    {
        ...
        else
        {
            ...
            Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_113/_MinThreshold.ascx", Model);
            Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_113/_MaxThreshold.ascx", Model);
            Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_113/_Hysteresis.ascx", Model);
        ...
        {
            Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_113/_PowerOption.ascx", Model);
        }
    }%>
