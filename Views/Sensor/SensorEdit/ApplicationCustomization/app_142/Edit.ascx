...
<% Account acc = Account.Load(Model.AccountID);
   ...
   {%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_142/_HeartBeat.ascx", Model); %>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_142/_ActiveStateInterval.ascx", Model);%>
<%}
   else
   { %>
...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_142/_MinMaxHyst.ascx", Model); %>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_142/_FrequencyMinMax.ascx", Model); %>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_142/_ModesAndSizes.ascx", Model); %>
