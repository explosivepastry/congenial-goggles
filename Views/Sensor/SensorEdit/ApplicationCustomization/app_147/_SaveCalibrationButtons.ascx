...
<%--        <button type="button" id="DefaultsCalibrate1" class="btn btn-secondary" style="float: none;" value="<%: Html.TranslateTag("Default","Default")%>">
        ...
        <button class="btn btn-primary" type="button" id="calibrateButton" onclick="postForm($(this).closest('form'));" style="float: none; margin-right: 10px;" value="<%: Html.TranslateTag("Calibrate","Calibrate")%> ">
