...
<%
    ...
    measurementInterval = (ThreePhaseCurrentMeter.GetMeasurementInterval(Model)).ToString("#0.###");    
%>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        createSpinnerModal("activeNum", "<%=Html.TranslateTag("Minutes") %>", "ActiveStateInterval", ActiveStateInterval_array);
        createSpinnerModal("measure", "<%=Html.TranslateTag("Minutes") %>", "MeasurementInterval_Manual", ActiveStateInterval_array);
