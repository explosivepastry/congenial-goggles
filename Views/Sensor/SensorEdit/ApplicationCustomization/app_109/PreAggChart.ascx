...
<%
    // 109 = ThreePhaseCurrentMeter PreAgg Chart

    StringBuilder minVals = new StringBuilder();
    StringBuilder maxVals = new StringBuilder();
    StringBuilder avgVals = new StringBuilder();
    double VoltValue = ThreePhaseCurrentMeter.GetVoltValue(Model.sensor.SensorID);
    string label = ThreePhaseCurrentMeter.GetLabel(Model.sensor.SensorID);
