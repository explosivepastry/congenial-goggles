...
<% Account acc = Account.Load(Model.AccountID);
    if (acc.CurrentSubscription.AccountSubscriptionType.Can("sensor_advanced_edit") && MonnitSession.CustomerCan("Sensor_Advanced_Configuration"))
    {
        ...
        else
        {
            ...
            Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_032/_Hysteresis.ascx", Model);
        ...
        Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Default/_SensorMode.ascx", Model);
