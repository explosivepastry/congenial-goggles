...
<%
    ...
    {
        minVals.Append("[new Date(" + item.Date.ToUniversalTime().ToEpochTime() + ")," + item.Min.LinearInterpolation(0, LowValue, 500, HighValue).ToString("#0.#", System.Globalization.CultureInfo.InvariantCulture) + "],");
        maxVals.Append("[new Date(" + item.Date.ToUniversalTime().ToEpochTime() + ")," + item.Max.LinearInterpolation(0, LowValue, 500, HighValue).ToString("#0.#", System.Globalization.CultureInfo.InvariantCulture) + "],");
        avgVals.Append("[new Date(" + item.Date.ToUniversalTime().ToEpochTime() + ")," + item.Avg.LinearInterpolation(0, LowValue, 500, HighValue).ToString("#0.#", System.Globalization.CultureInfo.InvariantCulture) + "],");
    }
