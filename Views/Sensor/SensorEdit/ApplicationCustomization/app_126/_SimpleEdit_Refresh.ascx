...
<%		
    ...
    //Profile Specific
    //Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_126/_MinThreshold.ascx", Model);
    //Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_126/_MaxThreshold.ascx", Model);	
%>

<% 	
	//Profile Specific Hidden
	Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_126/_XYZDelta.ascx", Model);
    Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_126/_RearmTime.ascx", Model);	
%>
