...
<% 
    if (!Monnit.VersionHelper.IsVersion_1_0(Model))
    {
        ...
        long HumidMax = (System.Convert.ToInt32(Max) >> 16) / 100;
%>
...
<div class="row sensorEditForm">
    ...
    <div class="col sensorEditFormInput">
        <input class="form-control" type="number" <%=Model.CanUpdate ? "" : "disabled" %> name="MaximumThreshold_Manual" id="MaximumThreshold_Manual" value="<%=HumidMax %>" />
        <a id="maxThreshNum1" style="cursor: pointer;"><%=Html.GetThemedSVG("list") %></a>
...
<script>
    ...
    { %>
        ...
        createSpinnerModal("maxThreshNum1", "Above", "MaximumThreshold_Manual", arrayForSpinner);
        <%}%>
