...
<%
    if (!Monnit.VersionHelper.IsVersion_1_0(Model))
    {
        ...
        long HystHumid = (System.Convert.ToUInt32(Hyst) >> 16) / 100;

%>

<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_043|Aware State Buffer","Aware State Buffer")%>  %
    </div>
    <div class="col sensorEditFormInput" id="hyst3">

        <input class="form-control" type="number" <%=Model.CanUpdate ? "" : "disabled" %> name="Hysteresis_Manual" id="Hysteresis_Manual" value="<%=HystHumid %>" />
