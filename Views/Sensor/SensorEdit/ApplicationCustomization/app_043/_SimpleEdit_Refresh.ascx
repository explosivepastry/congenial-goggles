...
<%		
    //Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_043/_ScaleOptions.ascx", Model);
...
<%
    ...
    Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_043/_ShowGPP_Hidden.ascx", Model);
	Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_043/_Hysteresis_Hidden.ascx", Model);	
%>
