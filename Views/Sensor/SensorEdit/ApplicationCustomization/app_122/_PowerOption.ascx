...
<%
    bool viewable = VoltageMeter500VAC.ShowAdvCal(Model.SensorID);
...
<div class="row sensorEditForm">
    ...
    <div class="col sensorEditFormInput">
        <div class="form-check form-switch d-flex align-items-center ps-0">
            ...
            <input class="form-check-input my-0 y-0 mx-2" type="checkbox" name="showAdvCal" id="showAdvCal" <%= viewable ? "checked='checked'" : ""  %>>
...
<div class="row sensorEditForm viewPower" style="display: none;">
    ...
    <div class="col sensorEditFormInput">
        ...
        <%}
            ...
            { %>
        <select name="power" id="Select1" class="form-select" style="margin-left:0" <%=Model.CanUpdate ? "" : "disabled" %>>
            <option value="0" <%=Model.Calibration3 == 0 ? "selected='selected'" : "" %>><%: Html.TranslateTag("None","None")%></option>
            <option value="1" <%=Model.Calibration3 == 1 ? "selected='selected'" : "" %>><%: Html.TranslateTag("Digital High","Digital High")%></option>
            <option value="2" <%=Model.Calibration3 == 2 ? "selected='selected'" : "" %>><%: Html.TranslateTag("Digital Low","Digital Low")%></option>
...
<div class="row sensorEditForm viewPower" style="display: none;">
    ...
    <div class="col sensorEditFormInput">
        <input type="number" class="form-control" <%=Model.CanUpdate ? "" : "disabled" %> name="delay" id="delay" class="delaymil" value="<%=Model.Calibration4 %>" />
...
<script type="text/javascript">
    ...
    { %>
        ...
        const arrayForSpinner = arrayBuilder(50, 5000, 50);
