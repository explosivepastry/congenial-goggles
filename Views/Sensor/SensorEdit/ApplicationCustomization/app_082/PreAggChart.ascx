...
<%
    // 082 = Pressure 300 PSI PreAgg Chart

    StringBuilder minVals = new StringBuilder();
    StringBuilder maxVals = new StringBuilder();
    StringBuilder avgVals = new StringBuilder();
    double LowValue = Pressure300PSI.GetLowValue(Model.sensor.SensorID);
    double HighValue = Pressure300PSI.GetHighValue(Model.sensor.SensorID);
    string label = Pressure300PSI.GetLabel(Model.sensor.SensorID);
