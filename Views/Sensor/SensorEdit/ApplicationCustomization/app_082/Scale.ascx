...
<form action="/Overview/SensorScale/<%:Model.SensorID %>" id="SensorScale_<%:Model.SensorID %>" method="post">
    ...
    <div class="form-group hideMe" style="display:none;">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
            <input class="aSettings__input_input" type="text" id="lowValue" name="lowValue" value="<%:Monnit.Pressure300PSI.GetLowValue(Model.SensorID) %>" />
        </div>
        <div class="clear"></div>
        <br />
    </div>
    ...
    <div class="form-group hideMe" style="display:none;">
        <div class="aSettings__title">
            <label id="Label1"></label>
             <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_079|300 PSI Value:","300 PSI Value:")%>
        </div>
        <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
            <input class="aSettings__input_input" type="text" id="highValue" name="highValue" value="<%:Monnit.Pressure300PSI.GetHighValue(Model.SensorID) %>" />
        </div>
        <div class="clear"></div>
        <br />
    </div>
    <div class="form-group hideMe" style="display:none;">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
            <input class="aSettings__input_input" type="text" id="customLabel" name="customLabel" value="<%:Monnit.Pressure300PSI.GetCustomLabel(Model.SensorID) %>" />
        </div>
        <div class="clear"></div>
        <br />
    </div>
    <div class="form-group hideMe" style="display:none;">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
            <input class="aSettings__input_input" type="text" id="decimalTrunkValue" name="decimalTrunkValue" value="<%:Monnit.Pressure300PSI.GetDecimalTrunkValue(Model.SensorID) %>" />
        </div>
        <div class="clear"></div>
        <br />
    </div>
