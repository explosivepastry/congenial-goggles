...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Help/_Calval1Through4.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Help/_SRXTimeOut.ascx", Model);%>
