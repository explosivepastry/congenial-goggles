...
<%
    ...
    string Probe1Name = FilteredQuadTemperature.GetProbe1Label(Model.Sensors[0].SensorID);
    string Probe2Name = FilteredQuadTemperature.GetProbe2Label(Model.Sensors[0].SensorID);
    string Probe3Name = FilteredQuadTemperature.GetProbe3Label(Model.Sensors[0].SensorID);
    string Probe4Name = FilteredQuadTemperature.GetProbe4Label(Model.Sensors[0].SensorID);
    ...
    foreach (DataMessage item in list)
    {
        ...
        Probe1Vals.Append("[new Date(" + Monnit.TimeZone.GetLocalTimeById(item.MessageDate, MonnitSession.CurrentCustomer.Account.TimeZoneID).ToEpochTime() + ")," + Data.ProbeOne.ToDouble().ToString() + "," + ((item.State & 2) == 2 ).ToInt() + ", '"+ Probe1Name + "' ,'" + item.DataMessageGUID +  "' ],");
        Probe2Vals.Append("[new Date(" + Monnit.TimeZone.GetLocalTimeById(item.MessageDate, MonnitSession.CurrentCustomer.Account.TimeZoneID).ToEpochTime() + ")," + Data.ProbeTwo.ToDouble().ToString() + "," + ((item.State & 2) == 2 ).ToInt() + ", '" + Probe2Name + "' ,'" + item.DataMessageGUID +  "' ],");
        Probe3Vals.Append("[new Date(" + Monnit.TimeZone.GetLocalTimeById(item.MessageDate, MonnitSession.CurrentCustomer.Account.TimeZoneID).ToEpochTime() + ")," + Data.ProbeThree.ToDouble().ToString() + "," + ((item.State & 2) == 2 ).ToInt() + ", '" + Probe3Name + "','" + item.DataMessageGUID +  "' ],");
        Probe4Vals.Append("[new Date(" + Monnit.TimeZone.GetLocalTimeById(item.MessageDate, MonnitSession.CurrentCustomer.Account.TimeZoneID).ToEpochTime() + ")," + Data.ProbeFour.ToDouble().ToString() + "," + ((item.State & 2) == 2 ).ToInt() + ", '" + Probe4Name + "' ,'" + item.DataMessageGUID +  "' ],");
