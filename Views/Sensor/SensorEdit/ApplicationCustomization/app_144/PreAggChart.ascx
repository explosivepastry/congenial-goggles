...
<%
    // 144 = Pressure 750 PSI PreAgg Chart

    StringBuilder minVals = new StringBuilder();
    StringBuilder maxVals = new StringBuilder();
    StringBuilder avgVals = new StringBuilder();
    double LowValue = Pressure750PSI.GetLowValue(Model.sensor.SensorID);
    double HighValue = Pressure750PSI.GetHighValue(Model.sensor.SensorID);
    string label = Pressure750PSI.GetLabel(Model.sensor.SensorID);
    ...
    foreach (PreAggregatedData item in Model.PreAggregateList)
    {
        ...
        {
            min = min.LinearInterpolation(0, LowValue, 750, HighValue).ToString("#0.#", System.Globalization.CultureInfo.InvariantCulture).ToDouble();
            max = max.LinearInterpolation(0, LowValue, 750, HighValue).ToString("#0.#", System.Globalization.CultureInfo.InvariantCulture).ToDouble();
            avg = avg.LinearInterpolation(0, LowValue, 750, HighValue).ToString("#0.#", System.Globalization.CultureInfo.InvariantCulture).ToDouble();
        }
