...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_102/_MinThreshold.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_102/_MaxThreshold.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_102/_Hysteresis.ascx", Model);%>
<p class="useAwareState"></p>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_102/_ShowFullData.ascx", Model);%>
