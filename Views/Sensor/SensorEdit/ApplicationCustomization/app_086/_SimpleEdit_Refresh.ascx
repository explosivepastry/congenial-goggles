...
<%		
    ...
    //Profile Specific
    Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_086/_MinThreshold.ascx", Model);
    Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_086/_MaxThreshold.ascx", Model);
%>
<% 	
	//Profile Specifi Hidden
	Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_086/_Hysteresis_Hidden.ascx", Model);	
%>
