...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_035/_ScaleOptions.ascx", Model);%>
...
<%		
	...
	//Profile Specific
	Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_035/_MinThreshold.ascx", Model);
	Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_035/_MaxThreshold.ascx", Model);
%>
<% 	
	//Profile Specific Hidden
	Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_035/_Hysteresis_Hidden.ascx", Model);	
%>
<% 	
	//Hidden Defaults
