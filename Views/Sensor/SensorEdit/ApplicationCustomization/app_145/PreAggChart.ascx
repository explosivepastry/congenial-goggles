...
<%
    // 145 = Pressure 3000 PSI PreAgg Chart

    StringBuilder minVals = new StringBuilder();
    StringBuilder maxVals = new StringBuilder();
    StringBuilder avgVals = new StringBuilder();
    double LowValue = Pressure3000PSI.GetLowValue(Model.sensor.SensorID);
    double HighValue = Pressure3000PSI.GetHighValue(Model.sensor.SensorID);
    string label = Pressure3000PSI.GetLabel(Model.sensor.SensorID);
    ...
    foreach (PreAggregatedData item in Model.PreAggregateList)
    {
        ...
        {
            min = min.LinearInterpolation(0, LowValue, 3000, HighValue).ToString("#0.#", System.Globalization.CultureInfo.InvariantCulture).ToDouble();
            max = max.LinearInterpolation(0, LowValue, 3000, HighValue).ToString("#0.#", System.Globalization.CultureInfo.InvariantCulture).ToDouble();
            avg = avg.LinearInterpolation(0, LowValue, 3000, HighValue).ToString("#0.#", System.Globalization.CultureInfo.InvariantCulture).ToDouble();
        }
