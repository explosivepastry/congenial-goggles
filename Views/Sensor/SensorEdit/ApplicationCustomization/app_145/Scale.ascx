...
<form action="/Overview/SensorScale/<%:Model.SensorID %>" id="SensorScale_<%:Model.SensorID %>" method="post">
    ...
    <%
        string label = Pressure3000PSI.GetLabel(Model.SensorID);
        double getSavedVal = Pressure3000PSI.GetSavedValue(Model.SensorID);
    %>
    ...
    <div class="form-group hideMe" style="display:none;">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
            <input class="aSettings__input_input" type="text" id="lowValue" name="lowValue" value="<%:Monnit.Pressure3000PSI.GetLowValue(Model.SensorID) %>" />
        </div>
        <div class="clear"></div>
        <br />
    </div>
    ...
    <div class="form-group hideMe" style="display:none;">
        <div class="aSettings__title">
            ...
            <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_079|3000 PSI Value:","3000 PSI Value:")%>
        </div>
        <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
            <input class="aSettings__input_input" type="text" id="highValue" name="highValue" value="<%:Monnit.Pressure3000PSI.GetHighValue(Model.SensorID) %>" />
        </div>
        <div class="clear"></div>
        <br />
    </div>
    <div class="form-group hideMe" style="display:none;">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
            <input class="aSettings__input_input" type="text" id="customLabel" name="customLabel" value="<%:Monnit.Pressure3000PSI.GetCustomLabel(Model.SensorID) %>" />
        </div>
        <div class="clear"></div>
        <br />
    </div>
    <div class="form-group hideMe" style="display:none;">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
            <input class="aSettings__input_input" type="text" id="decimalTrunkValue" name="decimalTrunkValue" value="<%:Monnit.Pressure3000PSI.GetDecimalTrunkValue(Model.SensorID) %>" />
        </div>
        <div class="clear"></div>
        <br />
    </div>
