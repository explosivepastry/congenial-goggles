...
<%
    ...
    double maxAware = Model.Sensors[0].MaximumThreshold.ToDouble() / 10.0;
    double minAware = Model.Sensors[0].MinimumThreshold.ToDouble() / 10.0;

    StringBuilder dataVals = new StringBuilder();
    string label = Pressure3000PSI.GetLabel(Model.Sensors[0].SensorID);
