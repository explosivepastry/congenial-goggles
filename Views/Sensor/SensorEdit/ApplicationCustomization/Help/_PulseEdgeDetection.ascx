...
<div class="row">
    <div class="word-choice">
      <%: Html.TranslateTag("Filter","Filter")%>
    </div>
     <div class="word-def" >
       <%: Html.TranslateTag("Sensor/ApplicationCustomization/Help|Determines if there is a filter and at what Hz the filter is set to.","Determines if there is a filter and at what Hz the filter is set to.")%>
        <hr />
    </div>
</div>
