...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Help/_VehicleInterval.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Help/_VehicleExtras.ascx", Model);%>
