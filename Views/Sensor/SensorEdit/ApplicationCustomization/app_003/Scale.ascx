    ...
    <div class="formBody">
        ...
        <div class="row sensorEditForm">
            <div class="col-12 col-md-3">
                <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_003|Closed  Value")%>:
            </div>
            <div class="col sensorEditFormInput">
                <input class="form-control" type="text" id="zeroValueLabel" name="zeroValueLabel" value="<%:  (Monnit.DryContact.GetZeroValue(Model.SensorID)) %>" />
            </div>
        </div>
        <div class="row sensorEditForm">
            <div class="col-12 col-md-3">
                <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_003|Open Value")%>:
            </div>
            <div class="col sensorEditFormInput">
                <input class="form-control" type="text" id="oneValueLabel" name="oneValueLabel" value="<%: (Monnit.DryContact.GetOneValue(Model.SensorID)) %>" />
            </div>
        </div>
    </div>
