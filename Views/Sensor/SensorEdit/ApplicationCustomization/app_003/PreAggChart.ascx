...
<%   
    //  003 = Dry Contact PreAgg Chart
    StringBuilder trueCounts = new StringBuilder();
    StringBuilder falseCounts = new StringBuilder();
    string OneValue = DryContact.GetOneValue(Model.sensor.SensorID);
    string ZeroValue = DryContact.GetZeroValue(Model.sensor.SensorID);
