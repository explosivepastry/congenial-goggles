...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_026/_MinThreshold.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_026/_MaxThreshold.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_026/_Hysteresis.ascx", Model);%>
