...
<div class="row sensorEditForm">
    ...
    <div class="col sensorEditFormInput">
        <select id="DataMode_Manual" name="DataMode_Manual" class="form-select" <%:ViewData["disabled"].ToBool() ? "disabled" : ""%> style="margin-left:0">
...
<div class="row sensorEditForm">
    ...
    <div class="col sensorEditFormInput">
        <select id="AwareMode_Manual" name="AwareMode_Manual" class="form-select" <%:ViewData["disabled"].ToBool() ? "disabled" : ""%> style="margin-left:0">
