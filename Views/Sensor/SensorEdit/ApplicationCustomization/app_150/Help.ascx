...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Help/_WaterDetectExtras.ascx", Model);%>
<% Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Help/_App150_Extras.ascx", Model);%>
