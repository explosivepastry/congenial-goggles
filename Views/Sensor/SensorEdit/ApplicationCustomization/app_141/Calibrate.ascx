...
<form action="/Overview/SensorCalibrate/<%:Model.SensorID %>" id="Form1" method="post">
    ...
    <div class="form-group">
        <div class="bold col-md-3 col-sm-3 col-xs-12">
             <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_141|Observed Sensor Reading: (From sensor)","Observed Sensor Reading: (From sensor)")%>
        </div>
        ...
        <%: Html.TranslateTag("Average Current (Amps)","Average Current (Amps)")%>
        </div>
    </div>
    <div class="clear"></div>
    <br />
    <div class="form-group">
        <div class="bold col-md-3 col-sm-3 col-xs-12">
             <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_141|Actual Input: (External reference value)","Actual Input: (External reference value)")%>
        </div>
        <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
