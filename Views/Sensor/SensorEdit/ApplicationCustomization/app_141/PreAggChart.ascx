...
<%
    // 141 = 0-5 Amp Current Meter PreAgg Chart

    StringBuilder minVals = new StringBuilder();
    StringBuilder maxVals = new StringBuilder();
    StringBuilder avgVals = new StringBuilder();
    double VoltValue = CurrentZeroToTwentyAmp.GetVoltValue(Model.sensor.SensorID);
    string label = CurrentZeroToTwentyAmp.GetLabel(Model.sensor.SensorID);
