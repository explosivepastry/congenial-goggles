...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/Default|Aware State Buffer","Aware State Buffer")%> (Amps)
    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        createSpinnerModal("hystNum", "Amps", "Hysteresis_Manual", ["0", "1", "2", "3", "4", "5"]);
