    ...
    <div>
        ...
        <div class="row sensorEditForm">
            <div class="col-12 col-md-3">
                <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_072|Observed Sensor Reading:","Observed Sensor Reading:")%>
            </div>
        ...
        <div class="row sensorEditForm">
            <div class="col-12 col-md-3 calOptions">
                <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_072|Actual Input:","Actual Input:")%>
            </div>
