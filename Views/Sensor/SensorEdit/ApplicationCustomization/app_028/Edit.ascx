...
<%--Heading Offset--%>
            <% if (new Version(Model.FirmwareVersion) >= new Version("2.3.0.0"))
               {
                   Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_028/_HeadingOffset.ascx", Model);
               } %>

<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Default/_MinThreshold.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Default/_MaxThreshold.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_028/_Hysteresis.ascx", Model);%>
