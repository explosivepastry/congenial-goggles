    ...
    <div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12 mdBox">
                <input name="observed" id="Text1" value="<%: Model.LastDataMessage != null ? Model.LastDataMessage.AppBase.PlotValue.ToDouble().ToString("0.0") : "" %>" />
            </div>
        </div>
        <div class="clear"></div>
        <br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12 mdBox calOptions">
                <input name="actual" id="Text2" value="<%: Model.LastDataMessage != null ? Model.LastDataMessage.AppBase.PlotValue.ToDouble().ToString("0.0") : "" %>" />
            </div>
        </div>
        <div class="clear"></div>
        <br />
