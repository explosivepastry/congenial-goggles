...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_099/_MeasurementInterval.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_099/_RearmTime.ascx", Model);%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_099/_ResistanceDifferential.ascx", Model);%>
