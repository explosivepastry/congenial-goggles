...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/Default|Assessments per Heartbeat","Assessments per Heartbeat","Assessments per Heartbeat")%>
    </div>
    <div class="col sensorEditFormInput">

        <input <%=Model.CanUpdate ? "" : "disabled" %> class="form-control" id="MeasurementsPerTransmission" name="MeasurementsPerTransmission" value="<%=Model.MeasurementsPerTransmission %>" />
        <a id="mptNum" style="cursor: pointer;"><%=Html.GetThemedSVG("list") %></a>
