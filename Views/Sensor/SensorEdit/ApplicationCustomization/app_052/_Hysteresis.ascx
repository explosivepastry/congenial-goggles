...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/Default|Hysteresis","Hysteresis")%> (Kohms)
    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        createSpinnerModal("hystNum", "Hysteresis", "Hysteresis_Manual", arrayForSpinner);
