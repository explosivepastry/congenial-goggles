...
<%		
	...
	//Profile Specific
	Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_135/_MinThreshold.ascx", Model);
	Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_135/_MaxThreshold.ascx", Model);
    

	//Profile Specific Hidden
	Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_135/_Hysteresis_Hidden.ascx", Model);
%>
