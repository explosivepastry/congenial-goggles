...
<script type="text/javascript">
	...
	$(document).ready(function () {
        ...
        function MinThresMobiscroll(min, max, headertext) {
            ...
            const arrayForSpinner = arrayBuilder(min, max, 10);
            createSpinnerModal("minThreshNum", headertext, "MinimumThreshold_Manual", arrayForSpinner);
        }

        function MaxThresMobiscroll(min, max, headertext) {

            const arrayForSpinner = arrayBuilder(min, max, 10);
            createSpinnerModal("maxThreshNum", headertext, "MaximumThreshold_Manual", arrayForSpinner);
        }
