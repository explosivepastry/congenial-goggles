...
<div id="HiddenUntilUseCaseSelected">
	<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_103/_ScaleOptions.ascx", Model);%>
	<div id="ValuesThatGetRefreshed"><%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_103/_SimpleEdit_Refresh.ascx", Model);%></div>
