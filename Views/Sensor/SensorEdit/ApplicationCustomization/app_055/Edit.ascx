...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_055/_CTSize.ascx", Model); %>
    ...
    if (acc.CurrentSubscription.AccountSubscriptionType.Can("sensor_advanced_edit") && MonnitSession.CustomerCan("Sensor_Advanced_Configuration"))
    {
        ...
        else
        {
            ...
            if (Model.MonnitApplication.IsTriggerProfile == eApplicationProfileType.Interval)
            {
                ...
                Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_055/_MinThreshold.ascx", Model);
                Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_055/_MaxThreshold.ascx", Model);
                Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_055/_Hysteresis.ascx", Model);
            ...
            else //eApplicationProfileType.Trigger
            {
                ...
                Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Default/_RearmTime.ascx", Model);
            }
        }
    }
