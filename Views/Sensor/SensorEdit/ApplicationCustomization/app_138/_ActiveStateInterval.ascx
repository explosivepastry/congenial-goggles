...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/Default|Aware State Heartbeat","Aware State Heartbeat")%> (<%:Html.TranslateTag("Minutes") %>)
    ...
    { %>
        ...
        $("#ActiveStateInterval").change(function () {
            if (isANumber($("#ActiveStateInterval").val())) {
                ...
                $('#reArmNum').mobiscroll('option', {
                    max: $('#ActiveStateInterval').val()
                });
            }
            else {
