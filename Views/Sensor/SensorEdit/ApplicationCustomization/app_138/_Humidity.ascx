...
<% 
    string MinHumidity = PIRHumidity.GetHumidityMinThresh(Model).ToString("#0.##", System.Globalization.CultureInfo.InvariantCulture);
    string MaxHumidity = PIRHumidity.GetHumidityMaxThresh(Model).ToString("#0.##", System.Globalization.CultureInfo.InvariantCulture);
    string HystHumidity = PIRHumidity.GetHumidityAwareBuffer(Model).ToString("#0.##", System.Globalization.CultureInfo.InvariantCulture);
    long HumidityDefaultMin = 0;
    long HumidityDefaultMax = 100;
    double TempHystMax = 10;
%>

<p class="useAwareState">Enter Aware State Humidity</p>
...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_002|Aware State Buffer","Aware State Buffer")%>  (<%: Html.Label("%") %>)
    </div>
