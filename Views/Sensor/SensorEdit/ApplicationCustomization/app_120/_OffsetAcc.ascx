...
<%double intervalVal = (Model.Calibration3 / 1000d);
    if (new Version(Model.FirmwareVersion) >= new Version("14.26.17.6"))
    {
...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/Default|Averaging Interval","Averaging Interval")%> (<%: Html.TranslateTag("Sensor/ApplicationCustomization/Default|Seconds","Seconds")%>)
    </div>
    <div class="col sensorEditFormInput">
...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_120|Accumulate","Accumulate")%>
    </div>
...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3 ">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_120|Show Full Data Value","Show Full Data Value")%>
    </div>
    <div class="col sensorEditFormInput">
        <div class="form-check form-switch d-flex align-items-center ps-0">
