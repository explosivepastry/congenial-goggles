...
<form action="/Overview/SensorCalibrate/<%:Model.SensorID %>" id="Form2" method="post">
    ...
    <div class="row">
        <div class="bold col-md-3 col-sm-3 col-xs-12">
            <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_120|Observed Sensor Reading: (From sensor)", "Observed Sensor Reading: (From sensor)")%>
        </div>
    ...
    <div class="row">
        <div class="bold col-md-3 col-sm-3 col-xs-12 calOptions">
            <%: Html.TranslateTag("Sensor/ApplicationCustomization/app_120|Actual Input: (External reference value)", "Actual Input: (External reference value)")%>
        </div>
