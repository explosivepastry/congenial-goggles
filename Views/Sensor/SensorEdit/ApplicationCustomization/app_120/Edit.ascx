...
<% Account acc = Account.Load(Model.AccountID);
    if (acc.CurrentSubscription.AccountSubscriptionType.Can("sensor_advanced_edit") && MonnitSession.CustomerCan("Sensor_Advanced_Configuration"))
    {
        ...
        Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_120/_MinThreshold.ascx", Model);
        Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_120/_MaxThreshold.ascx", Model);
        Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_120/_Hysteresis.ascx", Model);
        Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_120/_OffsetAcc.ascx", Model);
