...
<% Account acc = Account.Load(Model.AccountID);
   ...
   {%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_111/_HeartBeat.ascx", Model); %>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_111/_ActiveStateInterval.ascx", Model);%>
