...
<%
    ...
    string relay1Name = LatchedDualControl.Relay1Name(sens.SensorID);
    string relay2Name = LatchedDualControl.Relay2Name(sens.SensorID);

    foreach (DataMessage item in list)
    {
        LatchedDualControl Data = Monnit.LatchedDualControl.Deserialize(sens.FirmwareVersion, item.Data);
