...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_158/_HeartBeat.ascx", Model); %>
...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_158/_PollIntervalHysteresis.ascx", Model);%>
<%--<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_158/_MaintainRelayPosition.ascx", Model);%>--%>
<%--<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Default/_Recovery.ascx", Model);%>--%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_158/_Relay.ascx", Model);%>
<%} %>
