...
<% 
    if (!Monnit.VersionHelper.IsVersion_1_0(Model))
    {
        ...
        Max = LightSensor.MaxThreshForUI(Model);
        Min = LightSensor.MinThreshForUI(Model);
...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/Default|Below","Below")%> (Lux)
    </div>
...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Sensor/ApplicationCustomization/Default|Above","Above")%> (Lux)
    </div>
    <div class="col sensorEditFormInput">
...
<script>
    ...
    $(function () {
        ...
        createSpinnerModal("minThreshNum", "Lux", "MinimumThreshold_Manual", arrayForSpinner);
        createSpinnerModal("maxThreshNum", "Lux", "MaximumThreshold_Manual", arrayForSpinner);
