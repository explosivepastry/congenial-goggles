...
<%
    ...
    //Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Default_Simple/_Scale.ascx", Model);
%>
...
<div id="HiddenUntilUseCaseSelected">
	...
	<div id="ValuesThatGetRefreshed"><%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_022/_SimpleEdit_Refresh.ascx", Model);%></div>
