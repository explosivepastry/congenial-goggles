...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_090/_OverflowCountAwareState.ascx", Model);%>
...
<% Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Help/_Accumulation.ascx", Model); %>
<% Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/Help/_PulseEdgeDetection.ascx", Model); %>
