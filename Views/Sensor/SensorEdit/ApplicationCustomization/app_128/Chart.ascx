...
<%
    ...
    bool isF = HandheldFoodProbe.IsFahrenheit(sens.SensorID);
    ...
    double maxAware = sens.MaximumThreshold.ToDouble() / 10.0;
    double minAware = sens.MinimumThreshold.ToDouble() / 10.0;

    if (isF)
    {
        maxAware = maxAware.ToDouble().ToFahrenheit();
        minAware = minAware.ToDouble().ToFahrenheit();
    }
