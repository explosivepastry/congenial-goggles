...
<%
    int dataViewType = ThreePhase500AmpMeter.GetDataViewOption(Model.SensorID);
%>

<div class="row sensorEditForm">
    <div class="col-12 col-md-3 7777">
    ...
    <div class="col sensorEditFormInput" style="justify-content: space-between; max-width: 273px">
        <div class="form-check form-switch d-flex align-items-center ps-0">
            ...
            <input class="form-check-input my-0 y-0 mx-2" type="checkbox" <%=Model.CanUpdate ? "" : "disabled" %> name="Accumulate_ManualChkBx" id="Accumulate_ManualChkBx" <%=ThreePhase500AmpMeter.GetAccumulate(Model) > 0 ? "checked" : "" %>>
        ...
        <div style="display: none;"><%: Html.TextBox("Accumulate_Manual",ThreePhase500AmpMeter.GetAccumulate(Model), (Dictionary<string,object>)ViewData["HtmlAttributes"])%></div>
    </div>
    <div>
        <!-- Add Help -->
    </div>
...
<div class="row sensorEditForm">
    ...
    <div class="col sensorEditFormInput">
        <select name="DataView_Manual" class="form-select" <%=Model.CanUpdate ? "" : "disabled" %>>
