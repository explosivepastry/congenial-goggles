...
<% 
    ...
    Phase123ThreshMin = (ThreePhase500AmpMeter.GetPhase1ThreshMin(Model) * 3.0).ToString();
    Phase123ThreshMax = (ThreePhase500AmpMeter.GetPhase1ThreshMax(Model)* 3.0).ToString();
    Phase123Hyst = (ThreePhase500AmpMeter.GetPhase1Hyst(Model)* 3.0).ToString();
    Phase123Duty = (ThreePhase500AmpMeter.GetPhase1Duty(Model) * 3.0).ToString();
    label = ThreePhase500AmpMeter.GetLabel(Model.SensorID).ToString();   
%>

<p class="useAwareState">All Phases Aware State Threshold</p>
    ...
    $(function () {
        ...
        $("#Phase123Min_Manual").change(function () {
            if (isANumber($("#Phase123Min_Manual").val())) {
                ...
                if ($("#Phase123Min_Manual").val() > 600)
                    $("#Phase123Min_Manual").val(600);
        ...
        $("#Phase123Max_Manual").change(function () {
            if (isANumber($("#Phase123Max_Manual").val())) {
                ...
                if ($("#Phase123Max_Manual").val() > 600)
                    $("#Phase123Max_Manual").val(600);
        ...
        $("#Phase123Duty_Manual").change(function () {
            if (isANumber($("#Phase123Duty_Manual").val())) {
                ...
                if ($("#Phase123Duty_Manual").val() > 600)
                    $("#Phase123Duty_Manual").val(600)
            }
            else {
