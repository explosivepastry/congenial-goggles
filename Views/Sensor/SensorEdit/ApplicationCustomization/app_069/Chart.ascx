...
<%
    ...
    string label = DualPulseCounter.GetLabel(Model.Sensors[0].SensorID);

    foreach (DataMessage item in list)
    {
        Monnit.DualPulseCounter Data = Monnit.DualPulseCounter.Deserialize(Model.Sensors[0].FirmwareVersion, item.Data);
                ...
                tooltip: {
                    ...
                    formatter: function (params) {
                        ...
                        switch (params.value[3]) {
                            case 'Count1':
                                valueString = 'Count 1: ' + params.value[1] + ' <%=label%>' + '<br/>';
                                break;
                            case 'Count2':
                                valueString = 'Count 2: ' + params.value[1] + ' <%=label%>' + '<br/>';
                                break;
                            default:
                                break;
                        }
