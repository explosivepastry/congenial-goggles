...
<div class="row sensorEditForm">
    ...
    <div class="col sensorEditFormInput">
        <input type="checkbox" <%=Model.CanUpdate ? "" : "disabled" %> name="EnableAveragingChk" id="EnableAveragingChk" <%=enableAveraging > 0 ? "checked" : "" %> data-toggle="toggle" data-on="<%: Html.TranslateTag("On", "On")%>" data-off="<%: Html.TranslateTag("Off", "Off")%>" />
...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Vibration Aware Threshold","Vibration Aware Threshold")%>
    </div>
    <div class="col sensorEditFormInput">
        <input class="aSettings__input_input" type="number" <%=Model.CanUpdate ? "" : "disabled" %> name="VibrationAwareThreshold" id="VibrationAwareThreshold" value="<%=vibrationAwareThreshold %>" />
        <%: label %>
...
<div class="row sensorEditForm">
    <div class="col-12 col-md-3">
        <%: Html.TranslateTag("Vibration Aware Buffer","Vibration Aware Buffer")%>
    </div>
    <div class="col sensorEditFormInput">
        <input class="aSettings__input_input" type="number" <%=Model.CanUpdate ? "" : "disabled" %> name="VibrationAwareThreshold" id="VibrationAwareBuffer" value="<%=vibrationAwareBuffer %>" />
        <%: label %>
...
<script>
    ...
    var measureInt_array = [0, 2, 5, 10, 20, 50, 100, 720];
