...
<% Account acc = Account.Load(Model.AccountID);
   ...
   {%>
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_095/_HeartBeat.ascx", Model); %>
<%}
   else
   { %>
...
<%Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_095/_MinMaxHyst.ascx", Model); %>
