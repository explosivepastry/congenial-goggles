...
<%
    // 094 = Current Meter 150 Amp PreAgg Chart

    StringBuilder minVals = new StringBuilder();
    StringBuilder maxVals = new StringBuilder();
    StringBuilder avgVals = new StringBuilder();
    double VoltValue = CurrentZeroToOneFiftyAmp.GetVoltValue(Model.sensor.SensorID);
    string label = CurrentZeroToOneFiftyAmp.GetLabel(Model.sensor.SensorID);
