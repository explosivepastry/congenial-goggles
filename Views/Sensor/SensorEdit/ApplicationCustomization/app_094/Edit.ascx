...
<% Account acc = Account.Load(Model.AccountID);
    if (acc.CurrentSubscription.AccountSubscriptionType.Can("sensor_advanced_edit") && MonnitSession.CustomerCan("Sensor_Advanced_Configuration"))
    {
        ...
        Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_094/_Hysteresis.ascx", Model);
        Html.RenderPartial("~/Views/Sensor/SensorEdit/ApplicationCustomization/app_094/_OffsetAcc.ascx", Model);
