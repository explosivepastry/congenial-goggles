...
public class WaterArea : MonnitApplicationBase
{
  private SensorAttribute _ChartFormat;

  public static long MonnitApplicationID => 78;

  public static string ApplicationName => "Water Area";

  public static eApplicationProfileType ProfileType => eApplicationProfileType.Trigger;

  public override string ChartType => "Point";

  public override long ApplicationID => WaterArea.MonnitApplicationID;

  public bool Present { get; set; }

  public override string Serialize() => this.Present.ToString();
  ...
  {
    return (MonnitApplicationBase) WaterArea.Deserialize(version, serialized);
  }

  public override string NotificationString => this.Present ? "Water Present" : "No Water Present";

  public override object PlotValue => (object) (this.Present ? 1 : 0);

  public static WaterArea Deserialize(string version, string serialized)
  {
    return new WaterArea() { Present = serialized.ToBool() };
  }

  public static WaterArea Create(byte[] sdm, int startIndex)
  {
    return new WaterArea()
    {
      Present = sdm[startIndex].ToBool()
    };
  }
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = WaterArea.MonnitApplicationID,
      SnoozeDuration = 60,
    ...
    NameValueCollection viewData)
  {
    if (string.IsNullOrEmpty(collection["EventDetectionType_Manual"]))
      return;
    sensor.EventDetectionType = !(collection["EventDetectionType_Manual"] == WaterArea.ValueForZero) ? (!(collection["EventDetectionType_Manual"] == WaterArea.ValueForOne) ? 2 : 1) : 0;
  }
  ...
  public static bool operator ==(WaterArea left, WaterArea right)
  {
  ...
  {
    return obj is WaterArea && this.Equals((MonnitApplicationBase) (obj as WaterArea));
  }

  public override bool Equals(MonnitApplicationBase right)
  {
    return right is WaterArea && this.Present == (right as WaterArea).Present;
  }
