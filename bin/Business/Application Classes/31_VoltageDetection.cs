...
// Type: Monnit.VoltageDetection120
...
public class VoltageDetection120 : DryContact
{
  private SensorAttribute _ChartFormat;

  public new static long MonnitApplicationID => 31 /*0x1F*/;

  public new static string ApplicationName => "120V Detection";

  public new static eApplicationProfileType ProfileType => eApplicationProfileType.Trigger;

  public new string ChartType => "Point";

  public override long ApplicationID => VoltageDetection120.MonnitApplicationID;
  ...
  {
    return (MonnitApplicationBase) VoltageDetection120.Deserialize(version, serialized);
  }

  public static VoltageDetection120 Deserialize(string version, string serialized)
  {
    VoltageDetection120 voltageDetection120 = new VoltageDetection120();
    voltageDetection120.Pressed = serialized.ToBool();
    return voltageDetection120;
  }

  public static VoltageDetection120 Create(byte[] sdm, int startIndex)
  {
    VoltageDetection120 voltageDetection120 = new VoltageDetection120();
    voltageDetection120.Pressed = sdm[startIndex].ToBool();
    return voltageDetection120;
  }
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = VoltageDetection120.MonnitApplicationID,
      SnoozeDuration = 60,
    ...
    NameValueCollection viewData)
  {
    if (string.IsNullOrEmpty(collection["EventDetectionType_Manual"]))
      return;
    sensor.EventDetectionType = collection["EventDetectionType_Manual"] == VoltageDetection120.ValueForZero ? 0 : 1;
  }
  ...
  public static bool operator ==(VoltageDetection120 left, VoltageDetection120 right)
  {
