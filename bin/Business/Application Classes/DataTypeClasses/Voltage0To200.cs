...
// Type: Monnit.Application_Classes.DataTypeClasses.Voltage0To200
...
internal class Voltage0To200(double v) : Voltage(v)
{
  ...
  {
    return i <= 0L ? Voltage0To200.getScales()[(int) (-1L * i)] : MonnitApplicationBase.GetScalingInfo(Sensor.Load(i));
  }
  ...
  public new static List<UnitConversion> GetScales(Sensor sens)
  {
    ...
    {
      new UnitConversion(1.0, 0.0, "Volts", "", "Volts")
    };
  }
}
