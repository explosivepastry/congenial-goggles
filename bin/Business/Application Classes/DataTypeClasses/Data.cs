...
// Type: Monnit.Application_Classes.DataTypeClasses.Data
...
internal class Data : DataTypeBase
{
  public string value;

  public override eDatumType datatype => eDatumType.Data;

  public override object compvalue => (object) this.value;

  public Data(string v) => this.value = v;

  public Data(int v)
  {
    try
    {
      this.value = Convert.ToString(v);
    }
    catch
    {
      this.value = "";
