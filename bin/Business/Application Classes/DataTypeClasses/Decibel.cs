...
// Type: Monnit.Application_Classes.DataTypeClasses.Decibel
...
public class Decibel : DataTypeBase
{
  public double value;

  public override eDatumType datatype => eDatumType.Decibel;

  public override object compvalue => (object) this.value;

  public Decibel(double v) => this.value = v;
