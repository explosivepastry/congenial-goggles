...
// Type: Monnit.Application_Classes.DataTypeClasses.MotionDetect
...
internal class MotionDetect(bool b) : BooleanData(b)
{
  public override eDatumType datatype => eDatumType.MotionDetect;

  public new static List<UnitConversion> GetScales(Sensor sens) => BooleanData.GetScales(sens);

  public static string GetNotifyWhenString() => "Notify when motion is";
