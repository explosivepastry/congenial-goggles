...
// Type: Monnit.Application_Classes.DataTypeClasses.VehicleDetect
...
internal class VehicleDetect : DataTypeBase
{
  public int value;

  public override eDatumType datatype => eDatumType.VehicleDetect;

  public override object compvalue => (object) this.value;

  public VehicleDetect(int v) => this.value = v;
