...
// Type: Monnit.Application_Classes.DataTypeClasses.MagnetDetect
...
internal class MagnetDetect(bool b) : BooleanData(b)
{
  public override eDatumType datatype => eDatumType.MagnetDetect;

  public new static List<UnitConversion> GetScales(Sensor sens) => BooleanData.GetScales(sens);

  public static string GetNotifyWhenString() => "Notify when magnet is";
