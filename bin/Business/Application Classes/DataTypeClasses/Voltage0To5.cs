...
// Type: Monnit.Application_Classes.DataTypeClasses.Voltage0To5
...
internal class Voltage0To5(double v) : Voltage(v)
{
  ...
  {
    return i <= 0L ? Voltage0To5.getScales()[(int) (-1L * i)] : MonnitApplicationBase.GetScalingInfo(Sensor.Load(i));
  }
