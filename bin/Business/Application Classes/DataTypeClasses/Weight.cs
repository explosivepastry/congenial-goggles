...
// Type: Monnit.Application_Classes.DataTypeClasses.Weight
...
internal class Weight : DataTypeBase
{
  public double value;

  public override eDatumType datatype => eDatumType.Weight;

  public override object compvalue => (object) this.value;

  public Weight(double v) => this.value = v;
