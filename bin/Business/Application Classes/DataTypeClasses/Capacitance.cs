...
// Type: Monnit.Application_Classes.DataTypeClasses.Capacitance
...
public class Capacitance : DataTypeBase
{
  public double value;

  public override eDatumType datatype => eDatumType.Capacitance;

  public override object compvalue => (object) this.value;

  public Capacitance(double inches) => this.value = inches;
