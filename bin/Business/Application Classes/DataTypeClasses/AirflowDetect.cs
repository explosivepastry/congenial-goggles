...
// Type: Monnit.Application_Classes.DataTypeClasses.AirflowDetect
...
internal class AirflowDetect(bool b) : BooleanData(b)
{
  public override eDatumType datatype => eDatumType.AirflowDetect;

  public new static List<UnitConversion> GetScales(Sensor sens) => BooleanData.GetScales(sens);

  public static string GetNotifyWhenString() => "Notify when airflow is";
