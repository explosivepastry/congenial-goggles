...
// Type: Monnit.Application_Classes.DataTypeClasses.CarDetected
...
internal class CarDetected(bool b) : BooleanData(b)
{
  public override eDatumType datatype => eDatumType.CarDetected;

  public new static List<UnitConversion> GetScales(Sensor sens) => BooleanData.GetScales(sens);

  public static string GetNotifyWhenString() => "Notify when car is";
