...
// Type: Monnit.Application_Classes.DataTypeClasses.LightDetect
...
internal class LightDetect(bool b) : BooleanData(b)
{
  public override eDatumType datatype => eDatumType.LightDetect;

  public new static List<UnitConversion> GetScales(Sensor sens) => BooleanData.GetScales(sens);

  public static string GetNotifyWhenString() => "Notify when light is";
