...
// Type: Monnit.Application_Classes.DataTypeClasses.Frequency
...
internal class Frequency : DataTypeBase
{
  public double value;

  public override eDatumType datatype => eDatumType.Frequency;

  public override object compvalue => (object) this.value;

  public Frequency(double v) => this.value = v;
