...
// Type: Monnit.Application_Classes.DataTypeClasses.Magnitude
...
internal class Magnitude : DataTypeBase
{
  public double value;

  public override eDatumType datatype => eDatumType.Magnitude;

  public override object compvalue => (object) this.value;

  public Magnitude(double v) => this.value = v;
