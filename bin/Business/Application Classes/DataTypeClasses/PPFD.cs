...
// Type: Monnit.Application_Classes.DataTypeClasses.PPFDData
...
internal class PPFDData : DataTypeBase
{
  public double value;

  public override eDatumType datatype => eDatumType.PPFDData;

  public override object compvalue => (object) this.value;

  public PPFDData(double v) => this.value = v;
