...
// Type: Monnit.Application_Classes.DataTypeClasses.ButtonPressed
...
internal class ButtonPressed(bool b) : BooleanData(b)
{
  public override eDatumType datatype => eDatumType.ButtonPressed;
