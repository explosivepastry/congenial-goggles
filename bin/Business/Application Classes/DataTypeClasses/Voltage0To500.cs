...
// Type: Monnit.Application_Classes.DataTypeClasses.Voltage0To500
...
internal class Voltage0To500(double v) : Voltage(v)
{
  public new double value;

  public override eDatumType datatype => eDatumType.Voltage0To500;

  public static NotificationScaleInfoModel GetScalingInfo(long i)
  {
    return i <= 0L ? Voltage0To500.getScales()[(int) (-1L * i)] : MonnitApplicationBase.GetScalingInfo(Sensor.Load(i));
  }
