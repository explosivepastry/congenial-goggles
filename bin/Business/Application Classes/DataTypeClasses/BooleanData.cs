...
// Type: Monnit.Application_Classes.DataTypeClasses.BooleanData
...
internal class BooleanData : DataTypeBase
{
  public bool value;

  public override eDatumType datatype => eDatumType.BooleanData;

  public override object compvalue => (object) this.value;

  public BooleanData(bool b) => this.value = b;
