...
// Type: Monnit.Application_Classes.DataTypeClasses.PAR_DLI
...
internal class PAR_DLI : DataTypeBase
{
  public double value;

  public override eDatumType datatype => eDatumType.PAR_DLI;

  public override object compvalue => (object) this.value;

  public PAR_DLI(double v) => this.value = v;
