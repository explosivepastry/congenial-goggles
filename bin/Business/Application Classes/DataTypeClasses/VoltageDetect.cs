...
// Type: Monnit.Application_Classes.DataTypeClasses.VoltageDetect
...
internal class VoltageDetect(bool b) : BooleanData(b)
{
  public override eDatumType datatype => eDatumType.VoltageDetect;

  public new static List<UnitConversion> GetScales(Sensor sens) => BooleanData.GetScales(sens);

  public static string GetNotifyWhenString() => "Notify when voltage is";
