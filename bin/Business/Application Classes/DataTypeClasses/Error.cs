...
// Type: Monnit.Application_Classes.DataTypeClasses.Error
...
internal class Error : DataTypeBase
{
  public double value;

  public override eDatumType datatype => eDatumType.Error;

  public override object compvalue => (object) this.value;

  public Error(double v) => this.value = v;
