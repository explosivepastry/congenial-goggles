...
// Type: Monnit.Application_Classes.DataTypeClasses.CrestFactor
...
internal class CrestFactor : DataTypeBase
{
  public double value;

  public override eDatumType datatype => eDatumType.CrestFactor;

  public override object compvalue => (object) this.value;

  public CrestFactor(double v) => this.value = v;
  ...
  public static string GetNotifyWhenString() => "Notify when crest factor is";
