...
public class ZeroToTenVolts : MonnitApplicationBase, ISensorAttribute
{
  ...
  public static long MonnitApplicationID => ZeroToTenVoltBase.MonnitApplicationID;

  public static string ApplicationName => "Voltage Meter - 10 VDC";

  public static eApplicationProfileType ProfileType => ZeroToTenVoltBase.ProfileType;

  public override string ChartType => "Line";

  public override long ApplicationID => ZeroToTenVolts.MonnitApplicationID;
  ...
  {
    return (MonnitApplicationBase) ZeroToTenVolts.Deserialize(version, serialized);
  }
  ...
  public override object PlotValue
  {
    get
    {
      return (object) this.Volts.LinearInterpolation(0.0, this.LowValue.Value.ToDouble(), 10.0, this.HighValue.Value.ToDouble());
    }
  }

  public static ZeroToTenVolts Deserialize(string version, string serialized)
  {
    return new ZeroToTenVolts()
    {
      Volts = serialized.ToDouble()
    };
  }

  public static ZeroToTenVolts Create(byte[] sdm, int startIndex)
  {
    return new ZeroToTenVolts()
    {
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = ZeroToTenVolts.MonnitApplicationID,
    ...
    NameValueCollection viewData)
  {
    ...
    if ((string.IsNullOrEmpty(collection["MaximumThreshold_Manual"]) || !double.TryParse(collection["MaximumThreshold_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("MaximumThreshold_Manual"))
      sensor.MaximumThreshold = sensor.DefaultValue<long>("DefaultMaximumThreshold");
    ZeroToTenVolts zeroToTenVolts = new ZeroToTenVolts();
    zeroToTenVolts.SetSensorAttributes(sensor.SensorID);
    double num1 = zeroToTenVolts.LowValue.Value.ToDouble();
    double num2 = zeroToTenVolts.HighValue.Value.ToDouble();
    if (!string.IsNullOrEmpty(collection["Hysteresis_Manual"]) || double.TryParse(collection["Hysteresis_Manual"], out result))
    {
      double num3 = Math.Abs((num2 - num1) / 10.0);
    ...
    if (!string.IsNullOrEmpty(collection["MinimumThreshold_Manual"]) || double.TryParse(collection["MinimumThreshold_Manual"], out result))
    {
      ...
      sensor.MinimumThreshold = x >= num1 ? (x <= num2 ? (x.LinearInterpolation(num1, 0.0, num2, 10.0) * 1000.0).ToLong() : (num2.LinearInterpolation(num1, 0.0, num2, 10.0) * 1000.0).ToLong()) : (num1.LinearInterpolation(num1, 0.0, num2, 10.0) * 1000.0).ToLong();
    }
    if (!string.IsNullOrEmpty(collection["MaximumThreshold_Manual"]) || double.TryParse(collection["MaximumThreshold_Manual"], out result))
    {
      ...
      sensor.MaximumThreshold = x >= num1 ? (x <= num2 ? (x.LinearInterpolation(num1, 0.0, num2, 10.0) * 1000.0).ToLong() : (num2.LinearInterpolation(num1, 0.0, num2, 10.0) * 1000.0).ToLong()) : (num1.LinearInterpolation(num1, 0.0, num2, 10.0) * 1000.0).ToLong();
    ...
    if (collection["showAdvCal"] == "on")
    {
      ...
      ZeroToTenVolts.SetShowAdvCal(sensor.SensorID, "true");
    }
    else
    {
      viewData["showAdvCal"] = "false";
      ZeroToTenVolts.SetShowAdvCal(sensor.SensorID, "false");
    }
  }
  ...
  public static void CalibrateSensor(Sensor sensor, NameValueCollection collection)
  {
    if (!(new Version(sensor.FirmwareVersion) > new Version("2.0.0.0")) && sensor.SensorTypeID != 4L)
      return;
    int num1 = (collection["observed"].ToDouble().LinearInterpolation(ZeroToTenVolts.GetLowValue(sensor.SensorID), 0.0, ZeroToTenVolts.GetHighValue(sensor.SensorID), 11.0) * 1000.0).ToInt();
    int num2 = (collection["actual"].ToDouble().LinearInterpolation(ZeroToTenVolts.GetLowValue(sensor.SensorID), 0.0, ZeroToTenVolts.GetHighValue(sensor.SensorID), 11.0) * 1000.0).ToInt();
    if (num1 > 0 && num2 > 0)
    {
    ...
    NameValueCollection viewData)
  {
    if (!string.IsNullOrEmpty(collection["lowValue"]))
      ZeroToTenVolts.SetLowValue(sensor.SensorID, collection["lowValue"].ToDouble());
    if (!string.IsNullOrEmpty(collection["highValue"]))
      ZeroToTenVolts.SetHighValue(sensor.SensorID, collection["highValue"].ToDouble());
    if (string.IsNullOrEmpty(collection["label"]))
      return;
    ZeroToTenVolts.SetLabel(sensor.SensorID, collection["label"]);
  }
  ...
  public static string HystForUI(Sensor sensor)
  {
    ...
    zeroToTenVolts.SetSensorAttributes(sensor.SensorID);
    double num1 = zeroToTenVolts.LowValue.Value.ToDouble();
    double num2 = Math.Abs((zeroToTenVolts.HighValue.Value.ToDouble() - num1) / 10.0);
  ...
  public static string MinThreshForUI(Sensor sensor)
  {
    ZeroToTenVolts zeroToTenVolts = new ZeroToTenVolts();
    zeroToTenVolts.SetSensorAttributes(sensor.SensorID);
    double lowY = zeroToTenVolts.LowValue.Value.ToDouble();
    double highY = zeroToTenVolts.HighValue.Value.ToDouble();
    return sensor.MinimumThreshold == (long) uint.MaxValue ? "" : (sensor.MinimumThreshold.ToDouble() / 1000.0).LinearInterpolation(0.0, lowY, 10.0, highY).ToString();
  }
  ...
  public static string MaxThreshForUI(Sensor sensor)
  {
    ...
    double lowY = zeroToTenVolts.LowValue.Value.ToDouble();
    double highY = zeroToTenVolts.HighValue.Value.ToDouble();
    return sensor.MaximumThreshold == (long) uint.MaxValue ? "" : ((double) sensor.MaximumThreshold / 1000.0).LinearInterpolation(0.0, lowY, 10.0, highY).ToString();
  }

  public override int GetHashCode() => base.GetHashCode();

  public static bool operator ==(ZeroToTenVolts left, ZeroToTenVolts right)
  {
  ...
  {
    return obj is ZeroToTenVolts && this.Equals((MonnitApplicationBase) (obj as ZeroToTenVolts));
  }

  public override bool Equals(MonnitApplicationBase right)
  {
    return right is ZeroToTenVolts && this.Volts == (right as ZeroToTenVolts).Volts;
  }
  ...
  public static long DefaultMaxThreshold => 11000;
  ...
  public new static NotificationScaleInfoModel GetScalingInfo(Sensor sens)
  {
    ...
    ZeroToTenVolts zeroToTenVolts = new ZeroToTenVolts();
    zeroToTenVolts.SetSensorAttributes(sens.SensorID);
    scalingInfo.Label = zeroToTenVolts.Label.Value.ToStringSafe();
    scalingInfo.profileLow = zeroToTenVolts.LowValue.Value.ToDouble();
    scalingInfo.profileHigh = zeroToTenVolts.HighValue.Value.ToDouble();
    scalingInfo.baseLow = 0.0;
    scalingInfo.baseHigh = 10.0;
    return scalingInfo;
  }
}
