...
// Type: Monnit.FilteredQuadTemperature
...
public class FilteredQuadTemperature : MonnitApplicationBase, ISensorAttribute
{
  ...
  public static long MonnitApplicationID => FilteredQuadTemperatureBase.MonnitApplicationID;

  public static string ApplicationName => "Filtered Quad Temperature";

  public static eApplicationProfileType ProfileType => FilteredQuadTemperatureBase.ProfileType;

  public override string ChartType => "Line";

  public override long ApplicationID => FilteredQuadTemperature.MonnitApplicationID;
  ...
  {
    string str = FilteredQuadTemperature.IsFahrenheit(sensorID) ? "Fahrenheit" : "Celsius";
  ...
  public static FilteredQuadTemperature Create(byte[] sdm, int startIndex)
  {
    return new FilteredQuadTemperature()
    {
  ...
  public static FilteredQuadTemperature Deserialize(string version, string serialized)
  {
    FilteredQuadTemperature filteredQuadTemperature = new FilteredQuadTemperature();
    if (!string.IsNullOrWhiteSpace(serialized))
    {
      string[] strArray = serialized.Split(',');
      if (strArray.Length < 4)
      {
        filteredQuadTemperature.ProbeOne = strArray[0].ToDouble();
        filteredQuadTemperature.ProbeTwo = strArray[0].ToDouble();
        filteredQuadTemperature.ProbeThree = strArray[0].ToDouble();
        filteredQuadTemperature.ProbeFour = strArray[0].ToDouble();
      }
      else
      {
        filteredQuadTemperature.ProbeOne = strArray[0].ToDouble();
        filteredQuadTemperature.ProbeTwo = strArray[1].ToDouble();
        filteredQuadTemperature.ProbeThree = strArray[2].ToDouble();
        filteredQuadTemperature.ProbeFour = strArray[3].ToDouble();
      }
    }
    else
    {
      filteredQuadTemperature.ProbeOne = 0.0;
      filteredQuadTemperature.ProbeTwo = 0.0;
      filteredQuadTemperature.ProbeThree = 0.0;
      filteredQuadTemperature.ProbeFour = 0.0;
    }
    return filteredQuadTemperature;
  }

  public override MonnitApplicationBase _Deserialize(string version, string serialized)
  {
    return (MonnitApplicationBase) FilteredQuadTemperature.Deserialize(version, serialized);
  }
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = FilteredQuadTemperature.MonnitApplicationID,
      SnoozeDuration = 60,
      Version = MonnitApplicationBase.NotificationVersion,
      Scale = FilteredQuadTemperature.IsFahrenheit(sensor.SensorID) ? "F" : "C"
    };
  }
  ...
  {
    bool flag = FilteredQuadTemperature.IsFahrenheit(sensor.SensorID);
    ...
    else
    {
      ...
      if ((string.IsNullOrEmpty(collection["HystFourthByte_Manual"]) || !double.TryParse(collection["HystFourthByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("HystFourthByte_Manual"))
        FilteredQuadTemperature.SetHystFourthByte(sensor, (sbyte) 0);
      if ((string.IsNullOrEmpty(collection["HystThirdByte_Manual"]) || !double.TryParse(collection["HystThirdByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("HystThirdByte_Manual"))
        FilteredQuadTemperature.SetHystThirdByte(sensor, (sbyte) 0);
      if ((string.IsNullOrEmpty(collection["HystSecondByte_Manual"]) || !double.TryParse(collection["HystSecondByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("HystSecondByte_Manual"))
        FilteredQuadTemperature.SetHystSecondByte(sensor, (sbyte) 0);
      if ((string.IsNullOrEmpty(collection["HystFirstByte_Manual"]) || !double.TryParse(collection["HystFirstByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("HystFirstByte_Manual"))
        FilteredQuadTemperature.SetHystFirstByte(sensor, (sbyte) 0);
      if ((string.IsNullOrEmpty(collection["MaxFourthByte_Manual"]) || !double.TryParse(collection["MaxFourthByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("MaxFourthByte_Manual"))
        FilteredQuadTemperature.SetMaxFourthByte(sensor, (sbyte) 125);
      if ((string.IsNullOrEmpty(collection["MaxThirdByte_Manual"]) || !double.TryParse(collection["MaxThirdByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("MaxThirdByte_Manual"))
        FilteredQuadTemperature.SetMaxThirdByte(sensor, (sbyte) 125);
      if ((string.IsNullOrEmpty(collection["MaxSecondByte_Manual"]) || !double.TryParse(collection["MaxSecondByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("MaxSecondByte_Manual"))
        FilteredQuadTemperature.SetMaxSecondByte(sensor, (sbyte) 125);
      if ((string.IsNullOrEmpty(collection["MaxFirstByte_Manual"]) || !double.TryParse(collection["MaxFirstByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("MaxFirstByte_Manual"))
        FilteredQuadTemperature.SetMaxFirstByte(sensor, (sbyte) 125);
      if ((string.IsNullOrEmpty(collection["MinFourthByte_Manual"]) || !double.TryParse(collection["MinFourthByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("MinFourthByte_Manual"))
        FilteredQuadTemperature.SetMinFourthByte(sensor, (sbyte) -40);
      if ((string.IsNullOrEmpty(collection["MinThirdByte_Manual"]) || !double.TryParse(collection["MinThirdByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("MinThirdByte_Manual"))
        FilteredQuadTemperature.SetMinThirdByte(sensor, (sbyte) -40);
      if ((string.IsNullOrEmpty(collection["MinSecondByte_Manual"]) || !double.TryParse(collection["MinSecondByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("MinSecondByte_Manual"))
        FilteredQuadTemperature.SetMinSecondByte(sensor, (sbyte) -40);
      if ((string.IsNullOrEmpty(collection["MinFirstByte_Manual"]) || !double.TryParse(collection["MinFirstByte_Manual"], out result)) && ((IEnumerable<string>) collection.AllKeys).Contains<string>("MinFirstByte_Manual"))
        FilteredQuadTemperature.SetMinFirstByte(sensor, (sbyte) -40);
      if (!string.IsNullOrEmpty(collection["HystFourthByte_Manual"]) && double.TryParse(collection["HystFourthByte_Manual"], out result))
        FilteredQuadTemperature.SetHystFourthByte(sensor, (sbyte) (collection["HystFourthByte_Manual"].ToDouble() * (flag ? 5.0 / 9.0 : 1.0) * 10.0));
      if (!string.IsNullOrEmpty(collection["HystThirdByte_Manual"]) && double.TryParse(collection["HystThirdByte_Manual"], out result))
        FilteredQuadTemperature.SetHystThirdByte(sensor, (sbyte) (collection["HystThirdByte_Manual"].ToDouble() * (flag ? 5.0 / 9.0 : 1.0) * 10.0));
      if (!string.IsNullOrEmpty(collection["HystSecondByte_Manual"]) && double.TryParse(collection["HystSecondByte_Manual"], out result))
        FilteredQuadTemperature.SetHystSecondByte(sensor, (sbyte) (collection["HystSecondByte_Manual"].ToDouble() * (flag ? 5.0 / 9.0 : 1.0) * 10.0));
      if (!string.IsNullOrEmpty(collection["HystFirstByte_Manual"]) && double.TryParse(collection["HystFirstByte_Manual"], out result))
        FilteredQuadTemperature.SetHystFirstByte(sensor, (sbyte) (collection["HystFirstByte_Manual"].ToDouble() * (flag ? 5.0 / 9.0 : 1.0) * 10.0));
      if (!string.IsNullOrEmpty(collection["MinFourthByte_Manual"]) && double.TryParse(collection["MinFourthByte_Manual"], out result))
      {
        if (flag)
        {
          ...
          FilteredQuadTemperature.SetMinFourthByte(sensor, (sbyte) collection["MinFourthByte_Manual"].ToDouble().ToCelsius().ToInt());
        }
        else
        {
          if (collection["MinFourthByte_Manual"].ToInt() < -40)
          ...
          FilteredQuadTemperature.SetMinFourthByte(sensor, (sbyte) collection["MinFourthByte_Manual"].ToDouble().ToInt());
        }
      }
      if (!string.IsNullOrEmpty(collection["MinThirdByte_Manual"]) && double.TryParse(collection["MinThirdByte_Manual"], out result))
      {
        if (flag)
        {
          ...
          FilteredQuadTemperature.SetMinThirdByte(sensor, (sbyte) collection["MinThirdByte_Manual"].ToDouble().ToCelsius().ToInt());
        }
        else
        {
          if (collection["MinThirdByte_Manual"].ToInt() < -40)
          ...
          FilteredQuadTemperature.SetMinThirdByte(sensor, (sbyte) collection["MinThirdByte_Manual"].ToDouble().ToInt());
        }
      }
      if (!string.IsNullOrEmpty(collection["MinSecondByte_Manual"]) && double.TryParse(collection["MinSecondByte_Manual"], out result))
      {
        if (flag)
        {
          ...
          FilteredQuadTemperature.SetMinSecondByte(sensor, (sbyte) collection["MinSecondByte_Manual"].ToDouble().ToCelsius().ToInt());
        }
        else
        {
          if (collection["MinSecondByte_Manual"].ToInt() < -40)
          ...
          FilteredQuadTemperature.SetMinSecondByte(sensor, (sbyte) collection["MinSecondByte_Manual"].ToDouble().ToInt());
        }
      }
      if (!string.IsNullOrEmpty(collection["MinFirstByte_Manual"]) && double.TryParse(collection["MinFirstByte_Manual"], out result))
      {
        if (flag)
        {
          ...
          FilteredQuadTemperature.SetMinFirstByte(sensor, (sbyte) collection["MinFirstByte_Manual"].ToDouble().ToCelsius().ToInt());
        }
        else
        {
          if (collection["MinFirstByte_Manual"].ToInt() < -40)
          ...
          FilteredQuadTemperature.SetMinFirstByte(sensor, (sbyte) collection["MinFirstByte_Manual"].ToDouble().ToInt());
        }
      }
      if (!string.IsNullOrEmpty(collection["MaxFourthByte_Manual"]) && double.TryParse(collection["MaxFourthByte_Manual"], out result))
      {
        if (flag)
        {
          ...
          FilteredQuadTemperature.SetMaxFourthByte(sensor, (sbyte) collection["MaxFourthByte_Manual"].ToDouble().ToCelsius().ToInt());
          if ((int) FilteredQuadTemperature.GetMaxFourthByte(sensor) < (int) FilteredQuadTemperature.GetMinFourthByte(sensor))
            FilteredQuadTemperature.SetMaxFourthByte(sensor, FilteredQuadTemperature.GetMinFourthByte(sensor));
        }
        else
        {
          if (collection["MaxFourthByte_Manual"].ToInt() < -40)
          ...
          FilteredQuadTemperature.SetMaxFourthByte(sensor, (sbyte) collection["MaxFourthByte_Manual"].ToDouble().ToInt());
          if ((int) FilteredQuadTemperature.GetMaxFourthByte(sensor) < (int) FilteredQuadTemperature.GetMinFourthByte(sensor))
            FilteredQuadTemperature.SetMaxFourthByte(sensor, FilteredQuadTemperature.GetMinFourthByte(sensor));
        }
      }
      if (!string.IsNullOrEmpty(collection["MaxThirdByte_Manual"]) && double.TryParse(collection["MaxThirdByte_Manual"], out result))
      {
        if (flag)
        {
          ...
          FilteredQuadTemperature.SetMaxThirdByte(sensor, (sbyte) collection["MaxThirdByte_Manual"].ToDouble().ToCelsius().ToInt());
          if ((int) FilteredQuadTemperature.GetMaxThirdByte(sensor) < (int) FilteredQuadTemperature.GetMinThirdByte(sensor))
            FilteredQuadTemperature.SetMaxThirdByte(sensor, FilteredQuadTemperature.GetMinThirdByte(sensor));
        }
        else
        {
          if (collection["MaxThirdByte_Manual"].ToInt() < -40)
          ...
          FilteredQuadTemperature.SetMaxThirdByte(sensor, (sbyte) collection["MaxThirdByte_Manual"].ToDouble().ToInt());
          if ((int) FilteredQuadTemperature.GetMaxThirdByte(sensor) < (int) FilteredQuadTemperature.GetMinThirdByte(sensor))
            FilteredQuadTemperature.SetMaxThirdByte(sensor, FilteredQuadTemperature.GetMinThirdByte(sensor));
        }
      }
      if (!string.IsNullOrEmpty(collection["MaxSecondByte_Manual"]) && double.TryParse(collection["MaxSecondByte_Manual"], out result))
      {
        if (flag)
        {
          ...
          FilteredQuadTemperature.SetMaxSecondByte(sensor, (sbyte) collection["MaxSecondByte_Manual"].ToDouble().ToCelsius().ToInt());
          if ((int) FilteredQuadTemperature.GetMaxSecondByte(sensor) < (int) FilteredQuadTemperature.GetMinSecondByte(sensor))
            FilteredQuadTemperature.SetMaxSecondByte(sensor, FilteredQuadTemperature.GetMinSecondByte(sensor));
        }
        else
        {
          if (collection["MaxSecondByte_Manual"].ToInt() < -40)
          ...
          FilteredQuadTemperature.SetMaxSecondByte(sensor, (sbyte) collection["MaxSecondByte_Manual"].ToDouble().ToInt());
          if ((int) FilteredQuadTemperature.GetMaxSecondByte(sensor) < (int) FilteredQuadTemperature.GetMinSecondByte(sensor))
            FilteredQuadTemperature.SetMaxSecondByte(sensor, FilteredQuadTemperature.GetMinSecondByte(sensor));
        }
      }
      if (!string.IsNullOrEmpty(collection["MaxFirstByte_Manual"]) && double.TryParse(collection["MaxFirstByte_Manual"], out result))
      {
        if (flag)
        {
          ...
          FilteredQuadTemperature.SetMaxFirstByte(sensor, (sbyte) collection["MaxFirstByte_Manual"].ToDouble().ToCelsius().ToInt());
          if ((int) FilteredQuadTemperature.GetMaxFirstByte(sensor) < (int) FilteredQuadTemperature.GetMinFirstByte(sensor))
            FilteredQuadTemperature.SetMaxFirstByte(sensor, FilteredQuadTemperature.GetMinFirstByte(sensor));
        }
        else
        {
          if (collection["MaxFirstByte_Manual"].ToInt() < -40)
          ...
          FilteredQuadTemperature.SetMaxFirstByte(sensor, (sbyte) collection["MaxFirstByte_Manual"].ToDouble().ToInt());
          if ((int) FilteredQuadTemperature.GetMaxFirstByte(sensor) < (int) FilteredQuadTemperature.GetMinFirstByte(sensor))
            FilteredQuadTemperature.SetMaxFirstByte(sensor, FilteredQuadTemperature.GetMinFirstByte(sensor));
        }
      }
    ...
    NameValueCollection returnData)
  {
    if (collection["TempScale"] == "on")
    {
      ...
      FilteredQuadTemperature.MakeFahrenheit(sensor.SensorID);
    }
    else
    {
      returnData["TempScale"] = "C";
      FilteredQuadTemperature.MakeCelsius(sensor.SensorID);
    }
  }
    ...
    if (!sensor.IsWiFiSensor)
    {
      if (collection["type"] == "basic")
      {
        ...
        if (!string.IsNullOrWhiteSpace(collection["probe1"]) && double.TryParse(collection["probe1"], out result))
          FilteredQuadTemperature.SetCalVal1FirstByte(sensor, (sbyte) collection["probe1"].ToInt());
        else
          FilteredQuadTemperature.SetCalVal1FirstByte(sensor, (sbyte) 0);
        if (!string.IsNullOrWhiteSpace(collection["probe2"]) && double.TryParse(collection["probe2"], out result))
          FilteredQuadTemperature.SetCalVal1SecondByte(sensor, (sbyte) collection["probe2"].ToInt());
        else
          FilteredQuadTemperature.SetCalVal1SecondByte(sensor, (sbyte) 0);
        if (!string.IsNullOrWhiteSpace(collection["probe3"]) && double.TryParse(collection["probe3"], out result))
          FilteredQuadTemperature.SetCalVal1ThirdByte(sensor, (sbyte) collection["probe3"].ToInt());
        else
          FilteredQuadTemperature.SetCalVal1ThirdByte(sensor, (sbyte) 0);
        if (!string.IsNullOrWhiteSpace(collection["probe4"]) && double.TryParse(collection["probe4"], out result))
          FilteredQuadTemperature.SetCalVal1FourthByte(sensor, (sbyte) collection["probe4"].ToInt());
        else
          FilteredQuadTemperature.SetCalVal1FourthByte(sensor, (sbyte) 0);
  ...
  public static bool operator ==(QuadTemperature left, FilteredQuadTemperature right)
  {
  ...
  {
    return obj is FilteredQuadTemperature && this.Equals((MonnitApplicationBase) (obj as FilteredQuadTemperature));
  }

  public override bool Equals(MonnitApplicationBase right)
  {
    return right is FilteredQuadTemperature && this.ProbeOne == (right as FilteredQuadTemperature).ProbeOne;
  }
