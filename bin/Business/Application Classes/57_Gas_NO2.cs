...
public class Gas_NO2 : MonnitApplicationBase
{
  private SensorAttribute _CorF;

  public static long MonnitApplicationID => 57;

  public static string ApplicationName => "NO2 Gas";

  public static eApplicationProfileType ProfileType => eApplicationProfileType.Interval;

  public override string ChartType => "Line";

  public override long ApplicationID => Gas_NO2.MonnitApplicationID;
  ...
  public override List<object> GetPlotValues(long sensorID)
  {
    ...
    {
      this.PlotValue,
      (object) (Gas_NO2.IsFahrenheit(sensorID) ? this.Temp.ToFahrenheit() : this.Temp)
    };
  }
  ...
  public override List<string> GetPlotLabels(long sensorID)
  {
    ...
    {
      "PPM",
      Gas_NO2.IsFahrenheit(sensorID) ? "Fahrenheit" : "Celsius"
    };
  }
  ...
  {
    return (MonnitApplicationBase) Gas_NO2.Deserialize(version, serialized);
  }
  ...
  public override string NotificationString
  {
    get
    {
      Console.WriteLine(this.PlotValue.ToString());
  ...
  public static Gas_NO2 Deserialize(string version, string serialized)
  {
    Gas_NO2 gasNo2 = new Gas_NO2();
    ...
    else
    {
      ...
      gasNo2.PPM = (double) strArray[0].ToInt();
      gasNo2.Temp = strArray.Length <= 1 ? 0.0 : strArray[1].ToDouble();
    }
    return gasNo2;
  }

  public static Gas_NO2 Create(byte[] sdm, int startIndex)
  {
    return new Gas_NO2()
    {
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = Gas_NO2.MonnitApplicationID,
      SnoozeDuration = 60,
  ...
  public new static List<byte[]> ActionControlCommand(Sensor sensor, string version)
  {
    ...
    if ((sensor.Calibration1 & 2147483648U /*0x80000000*/.ToLong()) == 2147483648U /*0x80000000*/.ToLong())
      numArrayList.Add(Gas_NO2Base.CalibrationFrameTemperature(sensor.SensorID, (double) (sensor.Calibration1 & 268435455L /*0x0FFFFFFF*/) / 10.0));
    else if ((sensor.Calibration2 & 2147483648U /*0x80000000*/.ToLong()) == 2147483648U /*0x80000000*/.ToLong())
      numArrayList.Add(Gas_NO2Base.CalibrationFrameZero(sensor.SensorID));
    else if ((sensor.Calibration3 & 2147483648U /*0x80000000*/.ToLong()) == 2147483648U /*0x80000000*/.ToLong())
      numArrayList.Add(Gas_NO2Base.CalibrationFrameSpan(sensor.SensorID, (double) (sensor.Calibration3 & 268435455L /*0x0FFFFFFF*/) / 100.0));
  ...
  public static bool operator ==(Gas_NO2 left, Gas_NO2 right)
  {
  ...
  {
    return obj is Gas_NO2 && this.Equals((MonnitApplicationBase) (obj as Gas_NO2));
  }

  public override bool Equals(MonnitApplicationBase right)
  {
    return right is Gas_NO2 && this.PPM == (right as Gas_NO2).PPM;
  }
