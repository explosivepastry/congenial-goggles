...
public class LiquidLevel24 : MonnitApplicationBase, ISensorAttribute
{
  private SensorAttribute _StandardOrMetric;

  public static long MonnitApplicationID => 36;

  public static string ApplicationName => "Liquid Level - 24 in";

  public static eApplicationProfileType ProfileType => eApplicationProfileType.Interval;

  public override string ChartType => "Line";

  public override long ApplicationID => LiquidLevel24.MonnitApplicationID;

  public double Inch { get; set; }

  public int State { get; set; }

  public override string Serialize() => $"{this.Inch.ToString()}|{this.State.ToString()}";
  ...
  public override List<string> GetPlotLabels(long sensorID)
  {
    ...
    {
      LiquidLevel24.IsInches(sensorID) ? "Inches" : "Centimeters"
    };
  }

  public override MonnitApplicationBase _Deserialize(string version, string serialized)
  {
    return (MonnitApplicationBase) LiquidLevel24.Deserialize(version, serialized);
  }
  ...
  public static LiquidLevel24 Deserialize(string version, string serialized)
  {
    LiquidLevel24 liquidLevel24 = new LiquidLevel24();
    string[] strArray = serialized.Split('|');
    liquidLevel24.Inch = strArray[0].ToDouble();
    liquidLevel24.State = strArray.Length <= 1 ? 0 : strArray[1].ToInt();
    return liquidLevel24;
  }

  public static LiquidLevel24 Create(byte[] sdm, int startIndex)
  {
    return new LiquidLevel24()
    {
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = LiquidLevel24.MonnitApplicationID,
      SnoozeDuration = 60,
      Scale = LiquidLevel24.IsInches(sensor.SensorID) ? "I" : "C",
    ...
    NameValueCollection viewData)
  {
    ...
    sensor.MeasurementsPerTransmission = !string.IsNullOrWhiteSpace(collection["MeasurementsPerTransmission"]) ? collection["MeasurementsPerTransmission"].ToInt() : 6;
    double result = 0.0;
    ...
    if (!string.IsNullOrEmpty(collection["MinimumThreshold_Manual"]))
    {
      ...
      if (sensor.MinimumThreshold > 2400L)
        sensor.MinimumThreshold = 2400L;
    }
    if (!string.IsNullOrEmpty(collection["MaximumThreshold_Manual"]))
    {
      ...
      if (sensor.MaximumThreshold > 2400L)
        sensor.MaximumThreshold = 2400L;
    ...
    NameValueCollection returnData)
  {
    if (collection["TempScale"] == "on")
    {
      ...
      LiquidLevel24.MakeInches(sensor.SensorID);
    }
    else
    {
      returnData["TempScale"] = "C";
      LiquidLevel24.MakeMetric(sensor.SensorID);
    }
  }

  public static void CalibrateSensor(Sensor sensor, NameValueCollection collection)
  {
    if (new Version(sensor.FirmwareVersion) >= new Version("2.5.4.1"))
    {
  ...
  {
    bool flag = LiquidLevel24.IsInches(sensor.SensorID);
  ...
  {
    bool flag = LiquidLevel24.IsInches(sensor.SensorID);
    return sensor.MinimumThreshold == (long) uint.MaxValue ? "" : (flag ? (Convert.ToDouble(sensor.MinimumThreshold) / 100.0).ToString("#0.#") : (Convert.ToDouble(sensor.MinimumThreshold) / 100.0).ToCentimeter().ToString("#0.#", (IFormatProvider) CultureInfo.InvariantCulture));
  }

  public static string MaxThreshForUI(Sensor sensor)
  {
    bool flag = LiquidLevel24.IsInches(sensor.SensorID);
    return sensor.MaximumThreshold == (long) uint.MaxValue ? "" : (flag ? (Convert.ToDouble(sensor.MaximumThreshold) / 100.0).ToString("#0.#", (IFormatProvider) CultureInfo.InvariantCulture) : (Convert.ToDouble(sensor.MaximumThreshold) / 100.0).ToCentimeter().ToString("#0.#"));
  }
  ...
  public new static List<byte[]> ActionControlCommand(Sensor sensor, string version)
  {
    ...
    if (new Version(sensor.FirmwareVersion) >= new Version("2.5.4.1"))
    {
      if (sensor.Calibration1 == 0L)
        numArray = LiquidLevel24Base.EmptyCalibration(sensor.SensorID, (double) sensor.Calibration2);
      else if (sensor.Calibration2 == 0L)
        numArray = LiquidLevel24Base.OneThirdCalibration(sensor.SensorID, (double) sensor.Calibration3);
      else if (sensor.Calibration3 == 0L)
        numArray = LiquidLevel24Base.TwoThirdCalibration(sensor.SensorID, (double) sensor.Calibration4);
      else if (sensor.Calibration4 == 0L)
        numArray = LiquidLevel24Base.FullCalibration(sensor.SensorID, (double) sensor.Calibration1);
    }
    else
      numArray = sensor.Calibration1 != 0L ? LiquidLevelBase.FullCalibration(sensor.SensorID, (double) sensor.Calibration3) : LiquidLevelBase.EmptyCalibration(sensor.SensorID, (double) sensor.Calibration2);
  ...
  public static bool operator ==(LiquidLevel24 left, LiquidLevel24 right)
  {
  ...
  {
    return obj is LiquidLevel24 && this.Equals((MonnitApplicationBase) (obj as LiquidLevel24));
  }

  public override bool Equals(MonnitApplicationBase right)
  {
    return right is LiquidLevel24 && this.Inch == (right as LiquidLevel24).Inch;
  }
  ...
  public static long DefaultMaxThreshold => 24;
}
