...
public class DuctTemperature : Temperature
{
  public new static long MonnitApplicationID => 84;

  public new static string ApplicationName => "Duct Temperature";
  ...
  public override List<string> GetPlotLabels(long sensorID)
  {
    ...
    {
      DuctTemperature.IsFahrenheit(sensorID) ? "Fahrenheit" : "Celsius"
    });
  }
  ...
  public static DuctTemperature Deserialize(string version, string serialized)
  {
    DuctTemperature ductTemperature = new DuctTemperature();
    ductTemperature.Temp = serialized.ToDouble();
    return ductTemperature;
  }

  public static DuctTemperature Create(byte[] sdm, int startIndex)
  {
    DuctTemperature ductTemperature = new DuctTemperature();
    ductTemperature.Temp = BitConverter.ToInt16(sdm, startIndex).ToDouble() / 10.0;
    return ductTemperature;
  }
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = DuctTemperature.MonnitApplicationID,
      SnoozeDuration = 60,
      Version = MonnitApplicationBase.NotificationVersion,
      Scale = DuctTemperature.IsFahrenheit(sensor.SensorID) ? "F" : "C"
    };
  }
  ...
  public static bool operator ==(DuctTemperature left, DuctTemperature right)
  {
    ...
    NameValueCollection viewData)
  {
    if (collection["TempScale"] == "on")
    {
      ...
      DuctTemperature.MakeFahrenheit(sensor.SensorID);
    }
    else
    {
      viewData["TempScale"] = "C";
      DuctTemperature.MakeCelsius(sensor.SensorID);
    }
  }
