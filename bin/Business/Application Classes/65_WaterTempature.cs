...
{
  public new static long MonnitApplicationID => 65;

  public new static string ApplicationName => "Water Temperature";
  ...
  public override List<string> GetPlotLabels(long sensorID)
  {
    ...
    {
      WaterTemperature.IsFahrenheit(sensorID) ? "Fahrenheit" : "Celsius"
    };
  }
  ...
  public static WaterTemperature Deserialize(string version, string serialized)
  {
    WaterTemperature waterTemperature = new WaterTemperature();
    waterTemperature.Temp = serialized.ToDouble();
    return waterTemperature;
  }

  public static WaterTemperature Create(byte[] sdm, int startIndex)
  {
    WaterTemperature waterTemperature = new WaterTemperature();
    waterTemperature.Temp = BitConverter.ToInt16(sdm, startIndex).ToDouble() / 10.0;
    return waterTemperature;
  }
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = WaterTemperature.MonnitApplicationID,
      SnoozeDuration = 60,
      Version = MonnitApplicationBase.NotificationVersion,
      Scale = WaterTemperature.IsFahrenheit(sensor.SensorID) ? "F" : "C"
    };
  }
  ...
  public static bool operator ==(WaterTemperature left, WaterTemperature right)
  {
    ...
    NameValueCollection viewData)
  {
    if (collection["TempScale"] == "on")
    {
      ...
      WaterTemperature.MakeFahrenheit(sensor.SensorID);
    }
    else
    {
      viewData["TempScale"] = "C";
      WaterTemperature.MakeCelsius(sensor.SensorID);
    }
  }
