...
public class QTipTemperature : Temperature
{
  public new static long MonnitApplicationID => 100;

  public new static string ApplicationName => "QTIP Temperature";
  ...
  public override List<string> GetPlotLabels(long sensorID)
  {
    ...
    {
      QTipTemperature.IsFahrenheit(sensorID) ? "Fahrenheit" : "Celsius"
    });
  }
  ...
  public static QTipTemperature Deserialize(string version, string serialized)
  {
    QTipTemperature qtipTemperature = new QTipTemperature();
    qtipTemperature.Temp = serialized.ToDouble();
    return qtipTemperature;
  }

  public static QTipTemperature Create(byte[] sdm, int startIndex)
  {
    QTipTemperature qtipTemperature = new QTipTemperature();
    qtipTemperature.Temp = BitConverter.ToInt16(sdm, startIndex).ToDouble() / 10.0;
    return qtipTemperature;
  }
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = QTipTemperature.MonnitApplicationID,
      SnoozeDuration = 60,
      Version = MonnitApplicationBase.NotificationVersion,
      Scale = QTipTemperature.IsFahrenheit(sensor.SensorID) ? "F" : "C"
    };
  }
  ...
  {
    Temperature.CalibrateSensor(sensor, collection);
  }
  ...
  public static bool operator ==(QTipTemperature left, QTipTemperature right)
  {
  ...
  public new static long DefaultMinThreshold => -400;

  public new static long DefaultMaxThreshold => 1250;
    ...
    NameValueCollection viewData)
  {
    if (collection["TempScale"] == "on")
    {
      ...
      QTipTemperature.MakeFahrenheit(sensor.SensorID);
    }
    else
    {
      viewData["TempScale"] = "C";
      QTipTemperature.MakeCelsius(sensor.SensorID);
    }
  }
