...
public class Asset : ActiveID
{
  public new static long MonnitApplicationID => 66;

  public new static string ApplicationName => nameof (Asset);

  public new static eApplicationProfileType ProfileType => eApplicationProfileType.Interval;

  public static Asset Deserialize(string version, string serialized) => new Asset();

  public static Asset Create(byte[] sdm, int startIndex) => new Asset();
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = Asset.MonnitApplicationID,
  ...
  {
    return obj is Asset && this.Equals((MonnitApplicationBase) (obj as Asset));
  }
}
