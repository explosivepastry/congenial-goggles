...
// Type: Monnit.VoltageDetection240
...
public class VoltageDetection240 : VoltageDetection120
{
  private SensorAttribute _ChartFormat;

  public new static long MonnitApplicationID => 54;

  public new static string ApplicationName => "240V Detection";

  public new static eApplicationProfileType ProfileType => eApplicationProfileType.Trigger;

  public new string ChartType => "Point";

  public override long ApplicationID => VoltageDetection240.MonnitApplicationID;

  public override MonnitApplicationBase _Deserialize(string version, string serialized)
  {
    return (MonnitApplicationBase) VoltageDetection240.Deserialize(version, serialized);
  }

  public static VoltageDetection240 Deserialize(string version, string serialized)
  {
    VoltageDetection240 voltageDetection240 = new VoltageDetection240();
    voltageDetection240.Pressed = serialized.ToBool();
    return voltageDetection240;
  }

  public static VoltageDetection240 Create(byte[] sdm, int startIndex)
  {
    VoltageDetection240 voltageDetection240 = new VoltageDetection240();
    voltageDetection240.Pressed = sdm[startIndex].ToBool();
    return voltageDetection240;
  }
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = VoltageDetection240.MonnitApplicationID,
      SnoozeDuration = 60,
    ...
    NameValueCollection viewData)
  {
    if (string.IsNullOrEmpty(collection["EventDetectionType_Manual"]))
      return;
    sensor.EventDetectionType = collection["EventDetectionType_Manual"] == VoltageDetection240.ValueForZero ? 0 : 1;
  }
  ...
  public static bool operator ==(VoltageDetection240 left, VoltageDetection240 right)
  {
