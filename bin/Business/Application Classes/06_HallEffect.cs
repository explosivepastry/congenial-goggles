...
public class HallEffect : MonnitApplicationBase
{
  private SensorAttribute _ChartFormat;

  public static long MonnitApplicationID => 6;

  public static string ApplicationName => "Magnetic Presence";

  public static eApplicationProfileType ProfileType => eApplicationProfileType.Trigger;

  public override string ChartType => "Point";

  public override long ApplicationID => HallEffect.MonnitApplicationID;
  ...
  public override List<AppDatum> Datums
  {
    get
    {
      ...
      {
        new AppDatum(eDatumType.BooleanData, "MagnetPresent", this.Present)
      });
    }
  }
  ...
  {
    return (MonnitApplicationBase) HallEffect.Deserialize(version, serialized);
  }

  public override string NotificationString
  {
    get => this.Present ? "Magnet Present" : "No Magnet Present";
  }

  public override object PlotValue => (object) (this.Present ? 1 : 0);

  public static HallEffect Deserialize(string version, string serialized)
  {
    return new HallEffect()
    {
      Present = serialized.ToBool()
    };
  }

  public static HallEffect Create(byte[] sdm, int startIndex)
  {
    return new HallEffect()
    {
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = HallEffect.MonnitApplicationID,
  ...
  public static bool operator ==(HallEffect left, HallEffect right)
  {
  ...
  {
    return obj is HallEffect && this.Equals((MonnitApplicationBase) (obj as HallEffect));
  }

  public override bool Equals(MonnitApplicationBase right)
  {
    return right is HallEffect && this.Present == (right as HallEffect).Present;
  }
