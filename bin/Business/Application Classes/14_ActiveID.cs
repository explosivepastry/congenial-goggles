...
public class ActiveID : MonnitApplicationBase
{
  public static long MonnitApplicationID => 14;

  public static string ApplicationName => "Active ID";

  public static eApplicationProfileType ProfileType => eApplicationProfileType.Interval;

  public override string ChartType => "None";

  public override long ApplicationID => ActiveID.MonnitApplicationID;
  ...
  {
    return (MonnitApplicationBase) ActiveID.Deserialize(version, serialized);
  }
  ...
  public static ActiveID Deserialize(string version, string serialized) => new ActiveID();

  public static ActiveID Create(byte[] sdm, int startIndex) => new ActiveID();
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = ActiveID.MonnitApplicationID,
  ...
  public static bool operator ==(ActiveID left, ActiveID right)
  {
  ...
  {
    return obj is ActiveID && this.Equals((MonnitApplicationBase) (obj as ActiveID));
  }
