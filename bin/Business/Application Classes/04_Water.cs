...
public class Water : MonnitApplicationBase
{
  private SensorAttribute _ChartFormat;

  public static long MonnitApplicationID => 4;

  public static string ApplicationName => "Water Detection";

  public static eApplicationProfileType ProfileType => eApplicationProfileType.Trigger;

  public override string ChartType => "Point";

  public override long ApplicationID => Water.MonnitApplicationID;
  ...
  {
    return (MonnitApplicationBase) Water.Deserialize(version, serialized);
  }
  ...
  public static Water Deserialize(string version, string serialized)
  {
    return new Water() { Present = serialized.ToBool() };
  }

  public static Water Create(byte[] sdm, int startIndex)
  {
    return new Water()
    {
  ...
  public new static Notification NotificationByApplicationID(Sensor sensor)
  {
    return new Notification()
    {
      ...
      ApplicationID = Water.MonnitApplicationID,
      SnoozeDuration = 60,
    ...
    NameValueCollection viewData)
  {
    if (string.IsNullOrEmpty(collection["EventDetectionType_Manual"]))
      return;
    sensor.EventDetectionType = !(collection["EventDetectionType_Manual"] == Water.ValueForZero) ? (!(collection["EventDetectionType_Manual"] == Water.ValueForOne) ? 2 : 1) : 0;
  }
  ...
  {
    return obj is Water && this.Equals((MonnitApplicationBase) (obj as Water));
  }

  public override bool Equals(MonnitApplicationBase right)
  {
    return right is Water && this.Present == (right as Water).Present;
  }
